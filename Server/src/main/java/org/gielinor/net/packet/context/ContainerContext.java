...
public final class ContainerContext implements Context {
     ...
     */
    public ContainerContext(Player player, int interfaceId, Item[] items, boolean clear) {
        this(player, interfaceId, 0, 0, items, 1, false);
        this.clear = clear;
    }
     ...
     * @param split       If the container should be split.
     */
    public ContainerContext(Player player, int interfaceId, int childId, int type, Item[] items, int length, boolean split, int[] amounts) {
        this.player = player;
    ...
    public ContainerContext(Player player, int interfaceId, int childId, int type, Item[] items, int length, boolean split) {
        this(player, interfaceId, childId, type, items, length, split, null);
    }
    ...
    public ContainerContext(Player player, int interfaceId, int childId, int type, Item[] items, boolean split, int... slots) {
        this(player, interfaceId, childId, type, items, split, null, slots);
    }
     ...
     * @param slots       The slots to update.
     */
    public ContainerContext(Player player, int interfaceId, int childId, int type, Item[] items, boolean split, int[] amounts, int... slots) {
        this.player = player;
        this.interfaceId = interfaceId;
        this.childId = childId;
        this.type = type;
