...
public class DisplayModelContext implements Context {
    ...
    /**
     * Construct a new {@code DisplayModelContext} {@code Object} used for displaying the player.
    ...
    /**
     * Construct a new {@code DisplayModelContext} {@code Object} used for displaying an NPC.
     * @param player The player reference.
    ...
    /**
     * Construct a new {@code DisplayModelContext} {@code Object} used by the other constructors or for displaying an item.
     * @param player The player reference.
