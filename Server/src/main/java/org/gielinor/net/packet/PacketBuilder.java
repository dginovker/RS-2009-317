...
public class PacketBuilder {
     ...
     */
    public PacketBuilder(int opcode, PacketHeader header, ByteBuffer buf) {
        this.opcode = opcode;
        this.header = header;
        this.buf = buf;
    }
     ...
     * @return
     */
    public PacketBuilder putBytes(byte[] datas, int offset, int len) {
     ...
     * @return
     */
    public PacketBuilder putA(int val) {
     ...
     * @return
     */
    public PacketBuilder putC(int val) {
        buf.put((byte) -val);
        return this;
    }
     ...
     * @return
     */
    public PacketBuilder putS(int val) {
     ...
     * @return
     */
    public PacketBuilder putTri(int val) {
        buf.put((byte) (val >> 16));
        buf.put((byte) (val >> 8));
        buf.put((byte) val);
        return this;
     ...
     * @return
     */
    public PacketBuilder putIntA(int val) {
        buf.put((byte) (val >> 8));
        buf.put((byte) val);
        buf.put((byte) (val >> 24));
        buf.put((byte) (val >> 16));
     ...
     * @return
     */
    public PacketBuilder putIntB(int val) {
        buf.put((byte) (val >> 16));
        buf.put((byte) (val >> 24));
        buf.put((byte) val);
        buf.put((byte) (val >> 8));
     ...
     * @return
     */
    public PacketBuilder putIntSmart(int val) {
     ...
     * @return
     */
    public PacketBuilder putString(String val) {
     ...
     * @return
     */
    public PacketBuilder putNewString(String val) {
        buf.put(val.getBytes());
        buf.put((byte) 0);
        return this;
    }
     ...
     * @return
     */
    public PacketBuilder putJagString(String val) {
        buf.put((byte) 0);
        buf.put(val.getBytes());
        buf.put((byte) 0);
        return this;
     ...
     * @return
     */
    public PacketBuilder putJagString2(String val) {
    ...
    public void putReverse(byte data[], int start, int offset) {
        for (int k = (offset + start) - 1; k >= offset; k--) {
            put(data[k]);
        }
    }
     ...
     * @return
     */
    public PacketBuilder put(PacketBuilder buffer) {
     ...
     * @return
     */
    public PacketBuilder putA(PacketBuilder buffer) {
        buffer.toByteBuffer().flip();
     ...
     * @return
     */
    public PacketBuilder setBitAccess() {
     ...
     * @return
     */
    public PacketBuilder setByteAccess() {
     ...
     * @return
     */
    public PacketBuilder getReverseA(byte[] is, int offset, int length) {
