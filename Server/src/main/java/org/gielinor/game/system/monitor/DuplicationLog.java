...
public final class DuplicationLog extends MessageLog {
    ...
    /**
     * The amount of milliseconds the player's actions should be logged. (days * hours * minutes * milliseconds)
     */
    ...
    /**
     * Checks if the player's actions should be logged (to find cause of duping).
