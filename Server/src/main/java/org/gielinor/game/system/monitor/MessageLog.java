...
public class MessageLog {
    ...
    /**
     * Constructs a new {@code MessageLog} {@code Object} without capacity and uniqueLogging mode disabled.
     */
    public MessageLog() {
        this(-1, false);
    }
    ...
    /**
     * Constructs a new {@code MessageLog} {@code Object} with uniqueLogging mode disabled.
    ...
    public void write(String fileName) {
        ...
        ByteBuffer buffer = ByteBuffer.allocate(size * 255);
