 ...
 */
public class RandomItemsCommand extends Command {
    ...
    public void execute(Player player, String[] args) {
        ...
        while (player.getInventory().freeSlots() > 0) {
            player.getInventory().add(new Item(ItemDefinition.getRandomDefinition(noted).getId(), 1));
        }
    }
}
