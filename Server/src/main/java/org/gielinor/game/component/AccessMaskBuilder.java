...
public final class AccessMaskBuilder {
     ...
     * @param allowed If the packet for the default option should be sent to the server.
     */
    ...
    /**
     * Sets right click option settings.
    ...
    /**
     * Sets interface events depth.
     * For example, we have inventory interface which is opened on gameframe interface (548)
