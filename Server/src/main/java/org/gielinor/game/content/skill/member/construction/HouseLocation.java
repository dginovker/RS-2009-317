...
public enum HouseLocation {
    NOWHERE(-1, null, -1, -1),
    RIMMINGTON(15478, Location.create(2953, 3224, 0), 1, 5000),
    TAVERLY(15477, Location.create(2893, 3465, 0), 10, 5000),
    POLLNIVNEACH(15479, Location.create(3340, 3003, 0), 20, 7500),
    RELLEKKA(15480, Location.create(2670, 3631, 0), 30, 10000),
    BRIMHAVEN(15481, Location.create(2757, 3178, 0), 40, 15000),
    YANILLE(15482, Location.create(2544, 3096, 0), 50, 25000);
    ...
    public String getName() {
        return TextUtils.formatDisplayName(name().toLowerCase());
    }
