...
public final class GrandExchangeEntry {
    ...
    /**
     * The total value amount of each the unique trades. <br>
     * This is used to calculate the average price, so we know whether or not to
     * update price.
     */
    ...
    public void influenceValue(int value) {
        if (value < this.value * 0.5) { //Makes sure the player can't influence too much
