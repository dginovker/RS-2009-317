...
import org.gielinor.game.content.skill.member.construction.conditions.DecorationCondition;
import org.gielinor.game.content.skill.member.construction.conditions.WateringcanCondition;
...
public enum Decoration {
     ...
     */
    BIG_DEAD_TREE(13411, 8173, 5, 31.0, WateringcanCondition.INSTANCE, new Item(8417)),
    BIG_TREE(13412, 8174, 10, 44.0, WateringcanCondition.INSTANCE, new Item(8419)),
    BIG_OAK_TREE(13413, 8175, 15, 70.0, WateringcanCondition.INSTANCE, new Item(8421)),
    BIG_WILLOW_TREE(13414, 8176, 30, 100.0, WateringcanCondition.INSTANCE, new Item(8423)),
    BIG_MAPLE_TREE(13415, 8177, 45, 122.0, WateringcanCondition.INSTANCE, new Item(8425)),
    BIG_YEW_TREE(13416, 8178, 60, 141.0, WateringcanCondition.INSTANCE, new Item(8427)),
    BIG_MAGIC_TREE(13417, 8179, 75, 223.0, WateringcanCondition.INSTANCE, new Item(8429)),

    /**
     * Garden tree decorations.
     */
    DEAD_TREE(13418, 8173, 5, 31.0, WateringcanCondition.INSTANCE, new Item(8417)),
    TREE(13419, 8174, 10, 44.0, WateringcanCondition.INSTANCE, new Item(8419)),
    OAK_TREE(13420, 8175, 15, 70.0, WateringcanCondition.INSTANCE, new Item(8421)),
    WILLOW_TREE(13421, 8176, 30, 100.0, WateringcanCondition.INSTANCE, new Item(8423)),
    MAPLE_TREE(13422, 8177, 45, 122.0, WateringcanCondition.INSTANCE, new Item(8425)),
    YEW_TREE(13423, 8178, 60, 141.0, WateringcanCondition.INSTANCE, new Item(8427)),
    MAGIC_TREE(13424, 8179, 75, 223.0, WateringcanCondition.INSTANCE, new Item(8429)),

    /**
     * Garden big plant 1 decorations.
     */
    FERN(13425, 8186, 1, 31.0, WateringcanCondition.INSTANCE, new Item(8431)),
    BUSH(13426, 8187, 6, 70.0, WateringcanCondition.INSTANCE, new Item(8433)),
    TALL_PLANT(13427, 8188, 12, 100.0, WateringcanCondition.INSTANCE, new Item(8435)),

    /**
     * Garden big plant 2 decorations.
     */
    SHORT_PLANT(13428, 8189, 1, 31.0, WateringcanCondition.INSTANCE, new Item(8431)),
    LARGE_LEAF_PLANT(13429, 8190, 6, 70.0, WateringcanCondition.INSTANCE, new Item(8433)),
    HUGE_PLANT(13430, 8191, 12, 100.0, WateringcanCondition.INSTANCE, new Item(8435)),
     ...
     * Parlour chair spot
     */
    CRUDE_CHAIR(13581, 8309, 1, 58.0, new Item(960, 2), new Item(ConConstants.NAILS, 2)),
    WOODEN_CHAIR(13582, 8310, 8, 87.0, new Item(960, 3), new Item(ConConstants.NAILS, 3)),
    ROCKING_CHAIR(13583, 8311, 14, 87.0, new Item(960, 3), new Item(ConConstants.NAILS, 3)),
     ...
     * Parlour rug spot
     */
    BROWN_RUG(13588, 8316, 2, 30.0, new Item(8790, 2)),
    RED_RUG(13591, 8317, 13, 60.0, new Item(8790, 4)),
    OPULENT_RUG(13594, 8318, 65, 360.0, new Item[]{ new Item(8790, 4), new Item(4692, 1) }),
    ...
    DINING_TABLE_OPULENT(13299, 8121, 72, 3100.0, new Item[]{ new Item(8782, 6), new Item(8790, 4), new Item(4692, 4), new Item(8786, 2) }),
     ...
     */
    ROPE_PULL(13574, 8236, 5, 15.0, new Item[]{ new Item(954, 1), new Item(8778, 1) }),
    BELL_PULL(13575, 8237, 19, 58.0, new Item[]{ new Item(8780, 1), new Item(8790, 2) }),
    FANCY_BELL_PULL(13576, 8238, 33, 58.0, new Item[]{ new Item(8780, 1), new Item(8790, 2), new Item(4692, 1) }),
     ...
     */
    OAK_CHEST(13384, 8165, 34, 240.0, new Item(8778, 4)),
    TEAK_CHEST(13386, 8166, 44, 660.0, new Item[]{ new Item(8780, 4), new Item(4692, 1) }),
    MAHOGANY_CHEST(13388, 8167, 54, 860.0, new Item[]{ new Item(8782, 4), new Item(4692, 1) }),
    ...
    private Decoration(int objectId, int interfaceItem, int level, double experience, Item... items) {
        this(objectId, interfaceItem, level, experience, new int[]{ Item.HAMMER, 8794 }, null, items);
    }
    ...
    private Decoration(int objectId, int interfaceItem, int level, double experience, DecorationCondition condition, Item... items) {
        this(objectId, interfaceItem, level, experience, new int[]{ Item.HAMMER, 8794 }, condition, items);
    }
