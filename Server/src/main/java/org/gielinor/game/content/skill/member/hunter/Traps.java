...
import org.gielinor.game.content.skill.member.hunter.NetTrapSetting.NetTrap;
...
public enum Traps {
    ...
    BOX_TRAP(new TrapSetting(10008, new int[]{ 19187 }, new int[]{ 1963, 12579, 1869, 9996, 5972, 12535 }, "lay", 19192, Animation.create(5208), new Animation(5207), 27), new BoxTrapNode(new int[]{ 5081 }, 27, 100, new Item[]{ new Item(10092) }, 1), new BoxTrapNode(new int[]{ 6918, 7289, 7290, 7291, 7292 }, 27, 100, new Item[]{ new Item(12184) }, 10), new BoxTrapNode(new int[]{ 1487 }, 27, 100, new Item[]{ new Item(4033, 1) }, 95), new BoxTrapNode(new int[]{ 7021, 7022, 7023 }, 48, 150, new Item[]{ new Item(12551, 1) }, 1), new BoxTrapNode(new int[]{ 5079 }, 53, 198, new Item[]{ new Item(10033, 1) }, 1), new BoxTrapNode(new int[]{ 5428, 5430, 5449, 5450, 5451 }, 56, 150, new Item[]{ new Item(12188) }, 1), new BoxTrapNode(new int[]{ 5080 }, 63, 265, new Item[]{ new Item(10034, 1) }, 1), new BoxTrapNode(new int[]{ 7012, 7014 }, 66, 400, new Item[]{ new Item(12535) }, 1), new BoxTrapNode(new int[]{ 7010, 7011 }, 77, 1100, new Item[]{ new Item(12539, 1) }, 1)),
    RABBIT_SNARE(new TrapSetting(10031, new int[]{ 19333 }, new int[]{}, "lay", -1, Animation.create(5208), Animation.create(5207), 27)),
    IMP_BOX(new MagicBoxSetting(), new TrapNode(new int[]{ 708, 709, 1531 }, 71, 450, new int[]{ -1, 19226 }, new Item[]{ new Item(10027) })),
    DEAD_FALL(new DeadfallSetting(), new TrapNode(new int[]{ 5089 }, 23, 128, new int[]{ 19213, 19214, 19218 }, new Item[]{ new Item(10113), new Item(526) }), new TrapNode(new int[]{ 5088 }, 33, 168, new int[]{ 19211, 19212, 19217 }, new Item[]{ new Item(10129), new Item(526) }), new TrapNode(new int[]{ 5086 }, 37, 204, new int[]{ 19208, 19208, 19217 }, new Item[]{ new Item(10105), new Item(526) }), new TrapNode(new int[]{ 7039 }, 44, 200, new int[]{ 28939, 28940, 28941 }, new Item[]{ new Item(12567), new Item(526) }), new TrapNode(new int[]{ 5087 }, 51, 200, new int[]{ 19209, 19210, 19216 }, new Item[]{ new Item(10109), new Item(526) })),
    NET_TRAP(new NetTrapSetting(), new TrapNode(new int[]{ 5117 }, 29, 152, new int[]{}, new Item[]{ new Item(10149) }), new TrapNode(new int[]{ 5114 }, 47, 224, new int[]{}, new Item[]{ new Item(10146) }), new TrapNode(new int[]{ 6921 }, 29, 152, new int[]{}, new Item[]{ new Item(12130) }), new TrapNode(new int[]{ 5115 }, 59, 272, new int[]{}, new Item[]{ new Item(10147) }), new TrapNode(new int[]{ 5116 }, 67, 304, new int[]{}, new Item[]{ new Item(10148) })),;
    ...
    public void dismantle(Player player, GameObject object) {
        if (!player.getHunterManager().isOwner(object)) {
            player.getActionSender().sendMessage("This isn't your trap!");
            return;
        }
        if (player.getHunterManager().getWrapper(object) == null) {
            System.err.println("No wrapper for " + object.getId() + " " + object.getLocation().toString());
            return;
        }
