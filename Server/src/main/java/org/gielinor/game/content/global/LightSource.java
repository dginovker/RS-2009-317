...
public enum LightSource {
    ...
    BUG_LANTERN(33, Equipment.UNLIT_BUG_LANTERN.getItem(), Equipment.LIT_BUG_LANTERN.getItem(), false, 97),
    BULLSEYE_LANTERN(49, new Item(4544, 1), new Item(4550, 1), false, -1),
     ...
     * @param player The player.
     * @return The light source object, or null if the player didn't have any light source.
     */
