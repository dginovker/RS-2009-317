...
public enum Stall {
    ...
    BAKER_STALL(new int[]{ 2561, 6163, 34384, 11730 }, 5, new int[][]{ { 1891, 1 }, { 2309, 1 }, { 1901, 1 } }, "a cake from the baker's stall.", 16, 634, 11),
    ...
    SILK_STALL(new int[]{ 34383, 2560, 11729 }, 20, new int[][]{ { 950, 1 } }, "some silk from the silk stall.", 24, 634, 10),
    ...
    FUR_STALL(new int[]{ 34387, 2563, 11732 }, 35, new int[][]{ { 6814, 1 }, { 958, 1 } }, "some fur from the fur stall.", 36, 634, 22),
    ...
    SILVER_STALL(new int[]{ 2565, 6164, 34382, 11734 }, 50, new int[][]{ { 442, 1 } }, "some silver from the silver stall.", 54, 634, 50),
    SPICE_STALL(new int[]{ 2564, 34386, 11733 }, 65, new int[][]{ { 2007, 1 } }, "some spice from the spice stall.", 81, 634, 100),
    ...
    GEM_STALL(new int[]{ 2562, 6162, 34385, 11731 }, 75, new int[][]{
        { 1623, 1 }, { 1621, 1 }, { 1619, 1 },
        { 1617, 1 }, { 1625, 1 }, { 1627, 1 },
        { 1629, 1 }, { 1637, 1 }, { 1641, 1 },
        { 1639, 1 }, { 1643, 1 }, { 1631, 1 }
    }, "a gem from the gem stall.", 160, 634, 340),
    //ape atoll:
    ...
    MONEKY_GENERAL(new int[]{ 4876 }, 5, new int[][]{ { 1931, 1 }, { Item.HAMMER, 1 }, { 20590, 1 } }, "a general item from the general stall.", 16, 4797, 10),
    ...
    public Item getRandomLoot() {
        int[] loot = getReward()[RandomUtil.random(getReward().length)];
