...
public enum GrandExchangeSlot {
    ...
    SLOT_3(
        ...
        new int[]{ 24940, 24941, 24942, 24943, 24944, 24945 }
    ),
    SLOT_4(
        ...
        new int[]{ 24947, 24948, 24949, 24950, 24951, 24952 }
    ),
    SLOT_5(
        ...
        new int[]{ 24954, 24955, 24956, 24957, 24958, 24959, 24960 }
    ),
    SLOT_6(
        ...
        new int[]{ 24961, 24962, 24963, 24964, 24965, 24966, 24967 }
    ),;
     ...
     */
    GrandExchangeSlot(int[] buttonIds, int[] statusIds, int[] offerIds, int statusId, int itemNameId, int itemId, int valueId, int[] disableIds) {
    ...
    /**
     * Gets the disable ids.
     *
     * @return The disable ids.
     */
    public int[] getDisableIds() {
        return disableIds;
    }
}
