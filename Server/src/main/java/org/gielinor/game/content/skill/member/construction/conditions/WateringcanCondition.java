package org.gielinor.game.content.skill.member.construction.conditions;
...
public class WateringcanCondition implements DecorationCondition {
     ...
     */
    private static final Item[] WATERING_CANS = new Item[]{ new Item(5340), new Item(5339), new Item(5338), new Item(5337), new Item(5336), new Item(5335), new Item(5334), new Item(5333) };
    ...
    public boolean hasRequirements(Player player, boolean message) {
        ...
        if (message) {
            player.getActionSender().sendMessage("You need a filled watering can in order to do this.");
        }
        return false;
    }
