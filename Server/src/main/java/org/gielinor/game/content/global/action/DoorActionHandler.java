...
import org.gielinor.parser.object.DoorDefinition.Door;
...
public final class DoorActionHandler {
    ...
    public static void handleDoor(final Player player, final GameObject object) {
        final GameObject second = getSecondDoor(object);
        GameObject o = null;
        if (object instanceof Constructed && (o = ((Constructed) object).getReplaced()) != null) {
            player.getActionSender().sendSound(new Audio(43));
        ...
        if (object.getDefinition().hasAction("close")) {
            if (second != null) {
                player.getActionSender().sendMessage("The doors appear to be stuck.");
                return;
            }
            Door d = DoorDefinition.forId(object.getId());
            if (d == null) {
                player.getActionSender().sendMessage("The door appears to be stuck.");
                return;
            }
        ...
        player.getActionSender().sendSound(new Audio(81));
        if (second != null) {
            Door s = DoorDefinition.forId(second.getId());
     ...
     */
    public static void handleAutowalkDoor(final Entity entity, final GameObject object, final Location endLocation) {
        ...
        if (entity instanceof Player) {
            ((Player) entity).getActionSender().sendSound(new Audio(3419));
        }
     ...
     * @param object the object.
     */
    public static void handleAutowalkDoor(final Entity entity, final GameObject object) {
        handleAutowalkDoor(entity, object, getEndLocation(entity, object));
    }
    ...
    public static Location getDestination(Entity entity, GameObject door) {
        if (DoorDefinition.forId(door.getId()) != null) {
            return null;
        }
     ...
     * @param restoreTicks    The amount of ticks before the door(s) should be closed again.
     */
    public static void autowalkFence(final Entity entity, final GameObject object, final int replaceId, final int secondReplaceId) {
        final GameObject second = getSecondDoor(object);
