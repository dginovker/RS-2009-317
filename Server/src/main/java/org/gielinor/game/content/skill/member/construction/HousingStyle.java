...
public enum HousingStyle {
    ...
    BASIC_WOOD(1, 5000, 7503, 0, 15313),
    BASIC_STONE(10, 5000, 7503, 1, 15307),
    WHITEWASHED_STONE(20, 7500, 7503, 2, 15309),
    FREMENNIK_STYLE_WOOD(30, 10000, 7503, 3, 15311),
    TROPICAL_WOOD(40, 15000, 7759, 0, 15305),
    FANCY_STONE(50, 25000, 7759, 1, 15315);
