...
public enum SilverProduct {
    UNBLESSED(15445, 1599, 1714, 16, 50, 1718),
    UNHOLY(15481, 1594, 1720, 17, 50, 1724),
    SICKLE(15459, 2976, 2961, 18, 50, -1),
    TIARA(15473, 5523, 5525, 23, 52.5, -1),;
...
//    SILVER_BOLTS(66, 9434, 9382, 21, 50, -1);
    ...
    /**
     * Gets a {@code SilverProduct} by the item id.
     *
     * @param itemId The id of the item.
     * @return The silver product.
     */
    public static SilverProduct forId(int itemId) {
        switch (itemId) {
            case 1718:
                return UNBLESSED;
            case 2961:
