...
public enum SummoningPouch {
     ...
     */
    SPIRIT_ZAMATRICE_POUCH(26, 12101, 43, 75.2, 6881, 0.9, 5, new Item(12159), new Item(12155), new Item(12155), new Item(12183, 88)),
     ...
     */
    PYRELORD_POUCH(30, 12816, 46, 202.4, 7377, 2.3, 5, new Item(12160), new Item(12155), new Item(20590), new Item(12183, 111)),
     ...
     */
    HYDRA_POUCH(60, 12025, 80, 140.8, 6811, 1.6, 9, new Item(12159), new Item(571), new Item(12155), new Item(12183, 128)),

    /**
     * Represents a spirit dagannoth pouch.
     */
    SPIRIT_DAGANNOTH_POUCH(61, 12017, 83, 364.8, 6804, 4.1, 9, new Item(12160), new Item(6155), new Item(12155), new Item(12183, 1)),

    /**
     * Represents a unicorn stallion pouch.
     */
    UNICORN_STALLION_POUCH(70, 12039, 89, 154.4, 6822, 1.8, 9, new Item(12159), new Item(237), new Item(12155), new Item(12183, 140)),

    /**
     * Represents a wolpertinger pouch.
     */
    WOLPERTINGER_POUCH(72, 12089, 92, 404.8, 6869, 4.5, 10, new Item(12160), new Item(2859), new Item(3226), new Item(12155), new Item(12183, 203)),

    /**
     * Represents a pack yak pouch.
     */
    PACK_YAK_POUCH(75, 12093, 96, 422.4, 6873, 4.8, 10, new Item(12160), new Item(10818), new Item(12155), new Item(12183, 211)),

    /**
     * Represents a fire titan pouch.
     */
    FIRE_TITAN_POUCH(57, 12802, 79, 695.2, 7355, 7.9, 9, new Item(12163), new Item(1442), new Item(12183, 198)),
    ...
    /**
     * Gets the summoning pouch for the given pouch id.
     *
     * @param pouchId The pouch id.
     * @return The summoning pouch.
     */
    public static SummoningPouch forPouchId(int pouchId) {
        for (SummoningPouch pouch : SummoningPouch.values()) {
            if (pouch.getPouchId() == pouchId) {
                return pouch;
            }
        }
        return null;
