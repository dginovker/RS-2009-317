...
/**
 * Represents the mushroom and onion recipe. This recipe consists of using a fried mushroom with a friend onion.
 * @author 'Vexia
 * @date 22/12/2013
 */
public class MushroomAndOnion extends Recipe {
    ...
    public void mix(final Player player, final NodeUsageEvent event) {
        ...
        player.getSkills().addExperience(Skills.COOKING, 120);
    }
