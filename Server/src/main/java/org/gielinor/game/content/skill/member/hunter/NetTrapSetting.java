...
public final class NetTrapSetting extends TrapSetting {
    ...
    public NetTrapSetting() {
        super(new int[]{ 19652, 19663, 19671, 19679, 28564 }, new Item[]{ new Item(20303), new Item(954) }, NetTrap.getIds(), new int[]{ 10142, 10143, 10144, 10145 }, "set-trap", 29, -1, new Animation(5215), Animation.create(5207), true);
    }

    @Override
    public boolean hasItems(Player player) {
        if (!super.hasItems(player)) {
            player.getActionSender().sendMessage("You need a net and a rope to set a net trap.");
            return false;
        }
        return true;
    }
