...
public abstract class CutscenePlugin extends ActivityPlugin {
    ...
    /**
     * Represents the pulse used when starting a cutscene. This is used to give dramatic
     * effect for entering a cutscene. In the future allow for this to be toggled.
     *
     * @author 'Vexia
     * @date 30/12/2013
     */
    ...
    /**
     * Represents the pulse used when ending a cutscene. This is used to give dramatic
     * effect for entering a cutscene.
     *
     * @author 'Vexia
     * @date 30/12/2013
     */
        ...
        public boolean pulse() {
            switch (counter++) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    Location loc = (Location) (player.getAttribute("real-end", null) != null ? player.getAttribute("real-end", null) : getSpawnLocation());
    ...
    /**
     * Method called when the dim interface is closed.
     * And you can see the cutscene.
     */
    public void open() {
