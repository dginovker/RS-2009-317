...
public final class RemoteViewer {
    ...
    public void startViewing() {
        ...
        player.getActionSender().sendMessage("You send the " + familiar.getName().toLowerCase() + " to fly " + (type == ViewType.STRAIGHT_UP ? "directly up" : "to the " + type.name().toLowerCase()) + "...");
    ...
    private boolean canView() {
        //player.getActionSender().sendMessage("There seems to be an obstruction in the direction; the familiar cannot fly there");
