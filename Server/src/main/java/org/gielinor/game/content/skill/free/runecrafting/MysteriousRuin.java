...
public enum MysteriousRuin {
    AIR(new int[]{ 2452, 7103, 7104, 14897 }, Location.create(2983, 3292, 0), Location.create(2841, 4829, 0), Talisman.AIR, Tiara.AIR),
    MIND(new int[]{ 2453, 7105, 7106, 14898 }, Location.create(2980, 3514, 0), Location.create(2793, 4828, 0), Talisman.MIND, Tiara.MIND),
    WATER(new int[]{ 2454, 7107, 7108 }, Location.create(3183, 3163, 0), Location.create(2726, 4832, 0), Talisman.WATER, Tiara.WATER),
    EARTH(new int[]{ 2455, 7109, 7110, 14900 }, Location.create(3304, 3475, 0), Location.create(2655, 4830, 0), Talisman.EARTH, Tiara.EARTH),
    FIRE(new int[]{ 2456, 7111, 7112, 14899, 14901 }, Location.create(3312, 3253, 0), Location.create(2574, 4849, 0), Talisman.FIRE, Tiara.FIRE),
    BODY(new int[]{ 2457, 7113, 7114 }, Location.create(3051, 3443, 0), Location.create(2521, 4834, 0), Talisman.BODY, Tiara.BODY),
    COSMIC(new int[]{ 2458, 7115, 7116, 14903 }, Location.create(2406, 4375, 0), Location.create(2162, 4833, 0), Talisman.COSMIC, Tiara.COSMIC),
    CHAOS(new int[]{ 2461, 7121, 7122, 14906 }, Location.create(3059, 3590, 0), Location.create(2281, 4837, 0), Talisman.CHAOS, Tiara.CHAOS),
    NATURE(new int[]{ 2460, 7119, 7120, 14905 }, Location.create(2869, 3021, 0), Location.create(2400, 4835, 0), Talisman.NATURE, Tiara.NATURE),
    LAW(new int[]{ 2459, 7117, 7118, 14904 }, Location.create(2857, 3379, 0), Location.create(2464, 4819, 0), Talisman.LAW, Tiara.LAW),
    DEATH(new int[]{ 2462, 7123, 7124, 14907 }, Location.create(1862, 4639, 0), Location.create(2208, 4830, 0), Talisman.DEATH, Tiara.DEATH),
    BLOOD(new int[]{ 2464, 30529, 30530, 27978 }, Location.create(3561, 9779, 0), Location.create(1736, 3831, 0), Talisman.BLOOD, Tiara.BLOOD);
