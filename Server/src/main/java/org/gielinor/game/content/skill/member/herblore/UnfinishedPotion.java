...
public enum UnfinishedPotion {
    GUAM(Herbs.GUAM.getProduct(), 1, new Item(91)),
    ...
    STAMINA_POTION_1(new Item(3022, 1), new Item(14742, 1), 77, new Item(14721), 25.5),
    STAMINA_POTION_2(new Item(3020, 1), new Item(14742, 2), 77, new Item(14723), 51),
    STAMINA_POTION_3(new Item(3018, 1), new Item(14742, 3), 77, new Item(14725), 76.5),
    STAMINA_POTION_4(new Item(3016, 1), new Item(14742, 4), 77, new Item(14727), 102),;
     ...
     */
    UnfinishedPotion(final Item base, final Item ingredient, final int level, final Item potion, double experience) {
        this.base = base;
    ...
    UnfinishedPotion(final Item base, final Item ingredient, final int level, final Item potion) {
        this(base, ingredient, level, potion, 0);
    }
