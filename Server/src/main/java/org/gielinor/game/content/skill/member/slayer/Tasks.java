...
public enum Tasks {
    ...
    ABERRANT_SPECTRES(new Task(new int[]{ 1604, 1605, 1606, 1607 }, new String[]{ "Aberrant spectres have an extremely potent stench that drains", "stats and life points. A nose peg, protects against the stench." }, 60, new Master[]{ Master.DURADEL, Master.CHAELDAR, Master.VANNAKA }, true, Equipment.NOSE_PEG)),
    ABYSSAL_DEMONS(new Task(new int[]{ 1615, 20415 }, new String[]{ "Abyssal Demons are nasty creatures to deal with, they aren't really part, ", "of this realm, and are able to move very quickly to trap their prey" }, 85, new Master[]{ Master.DURADEL, Master.CHAELDAR, Master.VANNAKA }, false)),
    ANKOU(new Task(new int[]{ 4381, 4382, 4383 }, new String[]{ "Neither skeleton nor ghost, but a combination of both." }, 1, new Master[]{ Master.VANNAKA }, true)),
    BANSHEE(new Task(new int[]{ 1612, 27272 }, new String[]{ "Banshees use a piercing scream to shock their enemies, you'll", "need some Earmuffs to protect yourself from them." }, 15, new Master[]{ Master.TURAEL, Master.CHAELDAR, Master.VANNAKA, Master.MAZCHNA }, true, Equipment.EARMUFFS)),
    BASILISKS(new Task(new int[]{ 1616, 1617, 4228 }, new String[]{ "A mirror shield is much necessary when hunting these", "mad creatures." }, 40, new Master[]{ Master.TURAEL, Master.MAZCHNA, Master.VANNAKA, Master.CHAELDAR }, false)),
    ...
    BLACK_DEMONS(new Task(new int[]{ 84, 677, 4702, 4703, 4704, 4705, 22052 }, new String[]{ "Black Demons are magic creatures that are weak to magic attacks.", "They're the strongest demon and very dangerous." }, 1, new Master[]{ Master.DURADEL }, false)),
    BLACK_DRAGONS(new Task(new int[]{ 50, 54, 4673, 4674, 4675, 4676, 3376 }, new String[]{ "Black dragons are the strongest dragons", "watch out for their firey breath" }, 1, new Master[]{ Master.DURADEL }, false)),
    BLOODVELDS(new Task(new int[]{ 1618, 1619, 6215, 27276 }, new String[]{ "Bloodvelds are strange demonic creatures, they use their long rasping tongue", "to feed on just about anything they can find." }, 50, new Master[]{ Master.VANNAKA, Master.CHAELDAR, Master.DURADEL }, false)),
    BLUE_DRAGONS(new Task(new int[]{ 55, 4681, 4682, 4683, 4684, 5178, 52, 4665, 4666 }, new String[]{ "Blue dragons aren't as strong as other dragons but they're still", "very powerful, watch out for their firey breath." }, 1, new Master[]{ Master.CHAELDAR, Master.DURADEL }, false)),
    BRINE_RATS(new Task(new int[]{ 3707 }, new String[]{ "Small little creatures they are, yet so very", "powerfull." }, 47, new Master[]{ Master.VANNAKA, Master.CHAELDAR }, false)),
    BRONZE_DRAGONS(new Task(new int[]{ 1590, 20270 }, new String[]{ "Bronze dragons aren't as strong as other dragons but they're still", "very powerful, watch out for their firey breath." }, 1, new Master[]{ Master.CHAELDAR }, false)),
    ...
    CAVE_HORRORS(new Task(new int[]{ 4353, 4354, 4355, 4356, 4357 }, new String[]{ "A Cave horror wears a creepy mask, it is", "prefered to wear a witchwood icon." }, 58, new Master[]{ Master.CHAELDAR }, false)),
    ...
    CYCLOPES(new Task(new int[]{ 116, 4291, 4292, 6078, 6079, 6080, 6081, 6269, 6270, 22463 }, new String[]{ "Large one eyed creatures who normally wield a", "large mallet." }, 1, new Master[]{ Master.MAZCHNA }, false)),
    DAGANNOTHS(new Task(new int[]{ 1338, 1339, 1340, 1341, 1342, 1343, 1344, 1345, 1346, 2881, 2883, 1347, 2882, 2454, 2455, 2456, 2887, 2888, 3591, 27259 }, new String[]{ "There are many types of Dagannoth, the most powerful being the three Dagannoth Kings." }, 1, new Master[]{ Master.VANNAKA }, false)),
    DARK_BEASTS(new Task(new int[]{ 2783, 24005 }, new String[]{ "A dark beast can attack using magic or melee." }, 90, new Master[]{ Master.DURADEL }, false)),
    ...
    DOG(new Task(new int[]{ 99, 3582, 1593, 1594, 1994 }, new String[]{ "Dogs are much like Wolves, they are pack creatures which will hunt in groups." }, 1, new Master[]{ Master.TURAEL, Master.MAZCHNA }, false)),
    DUST_DEVILS(new Task(new int[]{ 1624, 20423 }, new String[]{ "Dust Devils use clouds od dust, sand, ash, and whatever else, ", "they can inhale to blind and disorientate their victims." }, 65, new Master[]{ Master.VANNAKA, Master.CHAELDAR, Master.DURADEL }, false)),
    ...
    ELVES(new Task(new int[]{ 1184, 1183, 1185 }, new String[]{ "Elves are quick, agile and vicious fighters which", "often favour bows and polearms." }, 1, new Master[]{ Master.VANNAKA, Master.CHAELDAR }, false) {
    ...
    FIRE_GIANTS(new Task(new int[]{ 110, 1582, 1583, 1584, 1585, 1586, 7003, 7004, 22075 }, new String[]{ "Like other giants, Fire Giants often wield large weapons", "learn to recognise what kind of weapon it is, and act accordingly." }, 1, new Master[]{ Master.CHAELDAR, Master.DURADEL }, false)),
    ...
    GARGOYLES(new Task(new int[]{ 1610, 1611, 6389 }, new String[]{ "Gargoyles are winged creatures of stone. You'll need to fight them to", "near death before breaking them apart with a rock hammer." }, 75, new Master[]{ Master.CHAELDAR, Master.DURADEL }, false, Equipment.ROCK_HAMMER)),
    GHOSTS(new Task(new int[]{ 103, 104, 491, 1541, 1549, 2716, 2931, 4387, 388, 5342, 5343, 5344, 5345, 5346, 5347, 5348, 1698, 5349, 5350, 5351, 5352, 5369, 5370, 5371, 5372, 5373, 5374, 5572, 6094, 6095, 6096, 6097, 6098, 6504, 13645, 13466, 13467, 20085 }, new String[]{ "A Ghost is an undead monster that is found", "in various places and dungeons. " }, 1, new Master[]{ Master.TURAEL, Master.MAZCHNA }, false)),
    ...
    GOBLINS(new Task(new int[]{ 100, 101, 102, 444, 3060, 445, 1769, 1770, 1771, 1772, 1773, 1774, 1775, 1776, 2274, 2275, 2276, 2277, 2278, 2279, 2280, 2281, 2678, 2679, 2680, 2681, 3264, 3265, 3266, 3267, 3726, 4261, 4262, 4263, 4264, 4265, 4266, 4267, 4268, 4269, 4270, 4271, 4272, 4273, 4274, 4275, 4276, 4407, 4408, 4409, 4410, 4411, 4412, 4490, 4499, 4633, 4634, 4635, 4636, 4637, 5855, 5856, 6125, 6126, 6132, 6133, 6279, 6280, 6281, 6282, 6283, 6402, 6403, 6404, 6405, 6406, 6407, 6408, 6409, 6410, 6411, 6412, 6413, 6414, 6415, 6416, 6417, 6418, 6419, 6420, 6421, 6422, 6423, 6424, 6425, 6426, 6427, 6428, 6429, 6430, 6431, 6432, 6433, 6434, 6435, 6436, 6437, 6438, 6439, 6440, 6441, 6442, 6443, 6444, 6445, 6446, 6447, 6448, 6449, 6450, 6451, 6452, 6453, 6454, 6455, 6456, 6457, 6458, 6459, 6460, 6461, 6462, 6463, 6464, 6465, 6466, 6467, 6490, 6491, 6492, 6493, 6494, 6495 }, new String[]{ "Goblins are mostly just annoying, but they can be vicious.", "Watch out for the spears they sometimes carry." }, 1, new Master[]{ Master.TURAEL }, false)),
    GORAKS(new Task(new int[]{ 4418, 6218 }, new String[]{ "Goraks can be tough monsters to fight. Be prepared." }, 1, new Master[]{ Master.TURAEL }, false)),
    GREATER_DEMONS(new Task(new int[]{ 83, 4698, 4699, 4700, 4701, 6203, 6204, 6206, 6208, 22025 }, new String[]{ "Greater Demons are magic creatures so they are weak to magical attacks.", "They're the strongest demon and very dangerous." }, 1, new Master[]{ Master.CHAELDAR, Master.DURADEL }, false)),
    GREEN_DRAGON(new Task(new int[]{ 941, 4677, 4678, 4679, 4680 }, new String[]{ "Green dragons are very powerfull, they have fierce", "fiery breath." }, 1, new Master[]{ Master.VANNAKA }, false)),
    ...
    HELLHOUNDS(new Task(new int[]{ 49, 3586, 6210, 23133 }, new String[]{ "Hellhounds are mid to high level demons." }, 1, new Master[]{ Master.CHAELDAR }, false)),
    HILL_GIANTS(new Task(new int[]{ 117, 4689, 4690, 3058, 4691, 4692, 4693, 22098, 22100 }, new String[]{ "Hill giants can hit up to 19 damage, and they only attack with Melee." }, 1, new Master[]{ Master.MAZCHNA, Master.VANNAKA }, false)),
    ...
    IRON_DRAGONS(new Task(new int[]{ 1591, 20272 }, new String[]{ "Iron dragons aren't as strong as other dragons but they're still", "very powerful, watch out for their firey breath." }, 1, new Master[]{ Master.CHAELDAR, Master.DURADEL }, false)),
    ...
    KALPHITES(new Task(new int[]{ 1153, 1154, 1155, 1156, 1157, 1158, 1159, 1160, 1161 }, new String[]{ "Kalaphite are large insects which live in great hives under the desert sands." }, 1, new Master[]{ Master.MAZCHNA, Master.CHAELDAR }, false)),
    KILLERWATTS(new Task(new int[]{ 3201, 3202 }, new String[]{ "" }, 37, new Master[]{ Master.VANNAKA }, false) {
    ...
    KURASKS(new Task(new int[]{ 1608, 1609, 4229 }, new String[]{ "A kurask is a very quick creature." }, 70, new Master[]{ Master.CHAELDAR }, false)),
    LESSER_DEMONS(new Task(new int[]{ 82, 3064, 4694, 4695, 4696, 4697, 6101, 22005 }, new String[]{ "Lesser Demons are magic creatures so they are weak to magical attacks." }, 1, new Master[]{ Master.VANNAKA, Master.CHAELDAR }, false)),
    MITHRIL_DRAGON(new Task(new int[]{ 5363 }, new String[]{ "Mithril dragons aren't as strong as other dragons but they're still", "very powerful, watch out for their firey breath." }, 1, new Master[]{ Master.DURADEL }, false)),
    ...
    MOGRES(new Task(new int[]{ 2801 }, new String[]{ "Mogres are Slayer monsters and require level 32 Slayer to kill. " }, 32, new Master[]{ Master.MAZCHNA, Master.VANNAKA }, false)),
    ...
    MOSS_GIANTS(new Task(new int[]{ 112, 1587, 1588, 1681, 4534, 4688, 4706, 20891 }, new String[]{ "They are known to carry large sticks." }, 1, new Master[]{ Master.VANNAKA }, false)),
    NECHRYAELS(new Task(new int[]{ 1613, 27278 }, new String[]{ "Nechryael are demons of decay which summon small winged beings which", "help them fight their victems." }, 1, new Master[]{ Master.CHAELDAR, Master.DURADEL }, false)),
    ...
    PYREFIENDS(new Task(new int[]{ 1633, 1634, 1635, 1636, 6216, 6622, 6631, 6641, 6660, 6668, 6683, 6709, 6721 }, new String[]{ "A scorching hot creature, watch out!" }, 30, new Master[]{ Master.MAZCHNA, Master.VANNAKA }, false)),
    RATS(new Task(new int[]{ 2682, 2980, 2981, 3007, 88, 224, 4928, 4929, 4936, 4937, 3008, 3009, 3010, 3011, 3012, 3013, 3014, 3015, 3016, 3017, 3018, 4396, 4415, 7202, 7204, 7417, 7461, 87, 446, 950, 4395, 4922, 4923, 4924, 4925, 4926, 4927, 4942, 4943, 4944, 4945 }, new String[]{ "Quick little rodents!" }, 1, new Master[]{ Master.TURAEL }, false)),
    ...
    ROCK_SLUGS(new Task(new int[]{ 1622, 1623 }, new String[]{ "A rock slug can leave behind a trail of his presence.." }, 20, new Master[]{ Master.MAZCHNA }, false)),
    ...
    STEEL_DRAGONS(new Task(new int[]{ 1592, 3590, 20274 }, new String[]{ "Steel dragons aren't as strong as other dragons but they're still", "very powerful, watch out for their firey breath." }, 1, new Master[]{ Master.DURADEL }, false)),
    ...
    TROLLS(new Task(new int[]{ 72, 3584, 1106, 1107, 1108, 1109, 1110, 1111, 1112, 1138, 1560, 1561, 1562, 1563, 1564, 1565, 1566, 1935, 1936, 1937, 1938, 1939, 1940, 1941, 1942, 3840, 3841, 3842, 3843, 3845, 1933, 1934 }, new String[]{ "Trolls have a crushing attack, it's bets to wear a high crushing defence." }, 1, new Master[]{ Master.CHAELDAR, Master.DURADEL }, false)),
    TUROTHS(new Task(new int[]{ 1626, 1627, 1628, 1629, 1630, 1631, 1632 }, new String[]{ "Turoths are Slayer monsters that require a Slayer level of 55 to kill" }, 55, new Master[]{ Master.CHAELDAR, Master.CHAELDAR }, false)),
    ...
    WALL_BEASTS(new Task(new int[]{ 1827, 1826 }, new String[]{ "A spiny helmet or equivalent is required to start fighting one " }, 35, new Master[]{ Master.MAZCHNA }, false, Equipment.SPINY_HELMET) {
    ...
    ZOMBIES(new Task(new int[]{ 73, 74, 75, 76, 77, 419, 420, 421, 422, 423, 424, 1465, 1466, 1467, 1485, 1486, 2058, 2714, 2831, 2832, 2833, 2834, 2835, 2836, 2837, 2838, 2839, 2840, 2841, 2842, 2843, 2844, 2845, 2846, 2847, 2848, 2863, 2864, 2865, 2866, 2867, 2868, 2869, 2870, 2871, 2878, 3066, 3622, 4392, 4393, 4394, 5293, 5294, 5295, 5296, 5297, 5298, 5299, 5300, 5301, 5302, 5303, 5304, 5305, 5306, 5307, 5308, 5309, 5310, 5311, 5312, 5313, 5314, 5315, 5316, 5317, 5318, 5319, 5320, 5321, 5322, 5323, 5324, 5325, 5326, 5327, 5328, 5329, 5330, 5331, 5375, 5376, 5377, 5378, 5379, 5380, 5393, 5394, 5395, 5396, 5397, 5398, 5399, 5400, 5401, 5402, 5403, 5404, 5405, 5406, 5407, 5408, 5409, 5410, 5623, 5624, 5625, 5626, 5629, 5630, 5631, 5632, 5633, 5634, 5635, 5636, 5637, 5638, 5639, 5640, 5641, 5642, 5643, 5644, 5645, 5646, 5647, 5648, 5649, 5650, 5651, 5652, 5653, 5654, 5655, 5656, 5657, 5658, 5659, 5660, 5661, 5662, 5663, 5664, 5665, 6088, 6089, 6090, 6099, 6100, 6131, 6761, 6762, 6763 }, new String[]{ "Zombies are creatures with no brain, they do hit farley", "high though." }, 1, new Master[]{ Master.TURAEL, Master.MAZCHNA }, true)),
    CERBERUS(new Task(new int[]{ 28632, 28634 }, new String[]{ "Cerberus is about the best guard dog there is!" }, 91, new Master[]{ Master.VANNAKA, Master.CHAELDAR, Master.DURADEL }, false, 20 | 25 << 16) {
