...
public final class ShipCharter {
    ...
    public final static void open(final Player player) {
        ...
        if (current != null) {
            ...
            for (int component : hiddenComponents) {
                player.getActionSender().sendHideComponent(95, component, true);
            }
     ...
     */
    public static boolean handle(final Player player, final int button) {
    ...
    public final static int[] getHiddenComponents(final Player player, Destination base) {
        final Destination[] restrictions = new Destination[]{ Destination.OO_GLOG, Destination.SHIPYARD, Destination.PORT_TYRAS, Destination.CRANDOR };
                ...
                public boolean pulse() {
                    switch (count++) {
                        ...
                        case 5:
                            ...
                            player.getActionSender().sendMessage("You pay the fare and sail to " + TextUtils.formatDisplayName(name()) + ".");
                            return true;
                    }
                    return false;
                }
