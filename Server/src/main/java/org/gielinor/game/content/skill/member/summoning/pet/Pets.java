...
public enum Pets {
     ...
     * A terrier pet.
     */
    TERRIER(12512, 12513, -1, 6958, 6959, -1, 0.0033333333333333, 4, 2132, 2134, 2136, 2138, 10816, 9986, 9978, 526),
     ...
     * Rift Guardians.
     */
    RIFT_GUARDIAN_FIRE(40665, -1, -1, 27337, -1, -1, 0.0, 1),
    RIFT_GUARDIAN_AIR(40667, -1, -1, 27338, -1, -1, 0.0, 1),
    RIFT_GUARDIAN_MIND(40669, -1, -1, 27339, -1, -1, 0.0, 1),
    RIFT_GUARDIAN_WATER(40671, -1, -1, 27340, -1, -1, 0.0, 1),
    RIFT_GUARDIAN_EARTH(40673, -1, -1, 27341, -1, -1, 0.0, 1),
    RIFT_GUARDIAN_BODY(40675, -1, -1, 27342, -1, -1, 0.0, 1),
    RIFT_GUARDIAN_COSMIC(40677, -1, -1, 27343, -1, -1, 0.0, 1),
    RIFT_GUARDIAN_CHAOS(40679, -1, -1, 27344, -1, -1, 0.0, 1),
    RIFT_GUARDIAN_NATURE(40681, -1, -1, 27345, -1, -1, 0.0, 1),
    RIFT_GUARDIAN_LAW(40683, -1, -1, 27346, -1, -1, 0.0, 1),
    RIFT_GUARDIAN_DEATH(40685, -1, -1, 27347, -1, -1, 0.0, 1),
    RIFT_GUARDIAN_SOUL(40687, -1, -1, 27348, -1, -1, 0.0, 1),
    RIFT_GUARDIAN_ASTRAL(40689, -1, -1, 27349, -1, -1, 0.0, 1),
    RIFT_GUARDIAN_BLOOD(40691, -1, -1, 27350, -1, -1, 0.0, 1),

    /**
     * Boss Pets.
     */
    OLMLET(40851, -1, -1, 27520, -1, -1, 0.0, 1),
    DARK_CORE(32816, -1, -1, 20318, -1, -1, 0.0, 1),
    VENENATIS_SPIDERLING(33177, -1, -1, 20495, -1, -1, 0.0, 1),
    CALLISTO_CUB(33178, -1, -1, 20497, -1, -1, 0.0, 1),
    HELLPUPPY(33247, -1, -1, 20964, -1, -1, 0.0, 1),
    CHAOS_ELEMENTAL_JR(31995, -1, -1, 22055, -1, -1, 0.0, 1),
    SNAKELING(32921, -1, -1, 22130, -1, -1, 0.0, 1),
    MAGMA_SNAKELING(32939, -1, -1, 22131, -1, -1, 0.0, 1),
    TANZANITE_SNAKELING(32940, -1, -1, 22132, -1, -1, 0.0, 1),
    VET_ION(33179, -1, -1, 25559, -1, -1, 0.0, 1),
    VET_ION_REBORN(33180, -1, -1, 25560, -1, -1, 0.0, 1),
    SCORPIAS_OFFSPRING(33181, -1, -1, 25561, -1, -1, 0.0, 1),
    ABYSSAL_ORPHAN(33262, -1, -1, 25884, -1, -1, 0.0, 1),
    DAGANNOTH_SUPREME_JR(32643, -1, -1, 26628, -1, -1, 0.0, 1),
    DAGANNOTH_PRIME_JR(32644, -1, -1, 26629, -1, -1, 0.0, 1),
    DAGANNOTH_REX_JR(32645, -1, -1, 26630, -1, -1, 0.0, 1),
    BABY_MOLE(32646, -1, -1, 26635, -1, -1, 0.0, 1),
    PRINCE_BLACK_DRAGON(32653, -1, -1, 26636, -1, -1, 0.0, 1),
    KALPHITE_PRINCESS_1(32647, -1, -1, 26637, -1, -1, 0.0, 1),
    KALPHITE_PRINCESS_2(32654, -1, -1, 26638, -1, -1, 0.0, 1),
    SMOKE_DEVIL(32648, -1, -1, 26639, -1, -1, 0.0, 1),
    BABY_KRAKEN(32655, -1, -1, 26640, -1, -1, 0.0, 1),
    GENERAL_GRAARDOR_JR(Item.PET_GENERAL_GRAARDOR, -1, -1, NPCDefinition.GENERAL_GRAARDOR_JR, -1, -1, 0.0, 1),
    KRIL_TSUTSAROTH_JR(Item.PET_KRIL_TSUTSAROTH, -1, -1, NPCDefinition.KRIL_TSUTSAROTH_JR, -1, -1, 0.0, 1),
    KREE_ARRA_JR(Item.PET_KREE_ARRA, -1, -1, NPCDefinition.KREE_ARRA_JR, -1, -1, 0.0, 1),
    ZILYANA_JR(Item.PET_ZILYANA, -1, -1, NPCDefinition.ZILYANA_JR, -1, -1, 0.0, 1),
    TZREK_JAD(Item.TZREK_JAD, -1, -1, NPCDefinition.TZREK_JAD, -1, -1, 0.0, 1),
    SKOTOS(41273, -1, -1, 27671, -1, -1, 0.0, 1),

    /**
     * Skilling Pets.
     */
    HERON(33320, -1, -1, 26715, -1, -1, 0.0, 1),
    BEAVER(33322, -1, -1, 26717, -1, -1, 0.0, 1),
    RED_CHINCHOMPA(33323, -1, -1, 26756, -1, -1, 0.0, 1),
    GREY_CHINCHOMPA(33324, -1, -1, 26757, -1, -1, 0.0, 1),
    BLACK_CHINCHOMPA(33325, -1, -1, 26758, -1, -1, 0.0, 1),
    GOLD_CHINCHOMPA(33326, -1, -1, 26759, -1, -1, 0.0, 1),
    GIANT_SQUIRREL(40659, -1, -1, 27334, -1, -1, 0.0, 1),
    TANGLEROOT(40661, -1, -1, 27335, -1, -1, 0.0, 1),
    ROCKY(40663, -1, -1, 27336, -1, -1, 0.0, 1),

    /**
     * Rock Golems.
     */
    ROCK_GOLEM_ROCK(33321, -1, -1, 27439, -1, -1, 0.0, 1),
    ROCK_GOLEM_TIN(41187, -1, -1, 27440, -1, -1, 0.0, 1),
    ROCK_GOLEM_COPPER(41188, -1, -1, 27441, -1, -1, 0.0, 1),
    ROCK_GOLEM_IRON(41189, -1, -1, 27442, -1, -1, 0.0, 1),
    ROCK_GOLEM_BLURITE(41190, -1, -1, 27443, -1, -1, 0.0, 1),
    ROCK_GOLEM_SILVER(41191, -1, -1, 27444, -1, -1, 0.0, 1),
    ROCK_GOLEM_COAL(41192, -1, -1, 27445, -1, -1, 0.0, 1),
    ROCK_GOLEM_GOLD(41193, -1, -1, 27446, -1, -1, 0.0, 1),
    ROCK_GOLEM_MITHRIL(41194, -1, -1, 27447, -1, -1, 0.0, 1),
    ROCK_GOLEM_GRANITE(41195, -1, -1, 27448, -1, -1, 0.0, 1),
    ROCK_GOLEM_ADAMANT(41196, -1, -1, 27449, -1, -1, 0.0, 1),
    ROCK_GOLEM_RUNE(41197, -1, -1, 27450, -1, -1, 0.0, 1),


    /**
     * Other.
     */
    PHOENIX(40693, -1, -1, 27368, -1, -1, 0.0, 1),
    PENANCE_PRINCESS(32703, -1, -1, 26642, -1, -1, 0.0, 1),
    BLOODHOUND(39730, -1, -1, 26296, -1, -1, 0.0, 1),;
    ...
    public static boolean isBossPet(int itemId) {
        for (int bossPetItem : Item.BOSS_PET_ITEMS) {
            if (itemId == bossPetItem) {
                return true;
            }
        }
        return false;
     ...
     * @param food            The food item ids the pet uses.
     */
    private Pets(int babyItemId, int grownItemId, int overgrownItemId, int babyNpcId, int grownNpcId, int overgrownNpcId, double growthRate, int summoningLevel, boolean enabled, int... food) {
        this.babyItemId = babyItemId;
        this.grownItemId = grownItemId;
        this.overgrownItemId = overgrownItemId;
        this.babyNpcId = babyNpcId;
