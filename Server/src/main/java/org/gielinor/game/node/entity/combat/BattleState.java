...
public final class BattleState {
    ...
    private int thirdHit = -1;
    private int fourthHit = -1;
    ...
    public void setMaximumHit(int maximumHit) {
        this.maximumHit = (int) (maximumHit * (entity instanceof Player ? ((double) entity.getAttribute(BLUDGEON_SPECIAL_MULTIPLIER)) : 1.0));
    }
    ...
    public int getFourthHit() {
        return fourthHit;
    }

    public void setFourthHit(int fourthHit) {
        this.fourthHit = fourthHit;
    }
}
