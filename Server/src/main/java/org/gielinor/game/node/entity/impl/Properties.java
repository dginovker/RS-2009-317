...
public final class Properties {
     ...
     * The death animation.
     */
    private Animation deathAnimation = new Animation(/*9055*/836, Priority.HIGH);
    ...
    public int getCurrentCombatLevel() {
        if (entity instanceof Player) {
            ...
            if (player.getAttribute("COMBAT_LEVEL") != null) {
                return player.getAttribute("COMBAT_LEVEL");
            }
    ...
    public Animation getDefenceAnimation() {
        if (defenceAnimation != null && defenceAnimation.getId() == -1 && entity instanceof Player) {
            if (((Player) entity).getEquipment().get(Equipment.SLOT_SHIELD) != null) {
                defenceAnimation = new Animation(1156);
            }
        }
    ...
    public void setDeathAnimation(Animation deathAnimation) {
        if (deathAnimation.getId() == 9055 || deathAnimation.getId() == 7197) {
            deathAnimation = Animation.create(836);
        }
