...
public class SwitchAttack {
     ...
     * @param projectile th eprojectile.
     */
    public SwitchAttack(CombatSwingHandler handler, Animation animation, Graphics startGraphic, Projectile projectile) {
        this(handler, animation, startGraphic, null, projectile);
    }
     ...
     * @return <code>True</code> if seleced.
     */
