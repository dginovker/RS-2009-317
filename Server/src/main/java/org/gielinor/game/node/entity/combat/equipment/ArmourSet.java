...
public enum ArmourSet {
     ...
     */
    AHRIM(new Graphics(401, 96), new int[][]{
        { 4708, 4856, 4857, 4858, 4859 },
        { 4710, 4862, 4863, 4864, 4865 },
        { 4712, 4868, 4869, 4870, 4871 },
        { 4714, 4874, 4875, 4876, 4877 }
    }) {
        @Override
        public boolean effect(Entity e, Entity victim, BattleState state) {
            if (RandomUtil.random(100) < 20) {
     ...
     */
    GUTHAN(new Graphics(398, 96), new int[][]{
        { 4724, 4904, 4905, 4906, 4907 },
        { 4726, 4910, 4911, 4912, 4913 },
        { 4728, 4916, 4917, 4918, 4919 },
        { 4730, 4922, 4923, 4924, 4925 }
    }) {
        @Override
        public boolean effect(Entity e, Entity victim, BattleState state) {
            if (RandomUtil.random(100) < 25) {
     ...
     */
    KARIL(new Graphics(400, 96), new int[][]{
        { 4732, 4928, 4929, 4930, 4931 },
        { 4734, 4934, 4935, 4936, 4937 },
        { 4736, 4940, 4941, 4942, 4943 },
        { 4738, 4946, 4947, 4948, 4949 }
    }) {
        @Override
        public boolean effect(Entity e, Entity victim, BattleState state) {
            if (state.getEstimatedHit() > 9 && RandomUtil.random(100) < 20) {
     ...
     */
    TORAG(new Graphics(399, 96), new int[][]{
        { 4745, 4952, 4953, 4954, 4955 },
        { 4747, 4958, 4959, 4960, 4961 },
        { 4749, 4964, 4965, 4966, 4967 },
        { 4751, 4970, 4971, 4972, 4973 }
    }) {
        @Override
        public boolean effect(Entity e, Entity victim, BattleState state) {
            if (state.getEstimatedHit() > 0 && RandomUtil.random(100) < 20) {
     ...
     */
    VERAC(null, new int[][]{
        { 4753, 4976, 4977, 4978, 4979 },
        { 4755, 4982, 4983, 4984, 4985 },
        { 4757, 4988, 4989, 4990, 4991 },
        { 4759, 4994, 4995, 4996, 4997 }
    }) {
        @Override
        public boolean isUsing(Entity e) {
            return e instanceof NPC && e.getId() == 2030 || super.isUsing(e);
        }
    };
