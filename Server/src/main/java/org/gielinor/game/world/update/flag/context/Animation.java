...
public class Animation {
     ...
     * @param id The animation id.
     */
    public Animation(int id, int delay, boolean osrs) {
        this(id, delay, Priority.MID, osrs);
    }
     ...
     * @param id The animation id.
     */
    public Animation(int id, int delay, Priority priority, boolean osrs) {
        this(id + (osrs ? 16147 : 0), delay, priority);
    }
