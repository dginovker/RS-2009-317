...
public class RegionChunk {
    ...
    public void synchronize(Player player) {
        PacketBuilder buffer = UpdateAreaPosition.getChunkUpdateBuffer(player, currentBase);
     ...
     * @return <code>True</code> if an update occured.
     */
    protected boolean appendUpdate(Player player, PacketBuilder buffer) {
