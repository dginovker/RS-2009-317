package org.gielinor.cache.misc.buffer;
...
public final class ByteBufferUtils {
    ...
    public static void putRS2String(ByteBuffer buffer, String string) {
        buffer.put(string.getBytes()).put((byte) 10);
    }
    ...
    public static String readString(ByteBuffer buffer) {
        ...
        return new String(buffer.array(), i, buffer.arrayOffset() - i - 1);
    }
    ...
    public static Object getObject(ByteBuffer buffer) {
        ...
        if (length > 0) {
            ...
            buffer.get(bytes);
            try (ObjectInputStream ois = new ObjectInputStream(new BufferInputStream(ByteBuffer.wrap(bytes)))) {
                return ois.readObject();
            } catch (IOException | ClassNotFoundException ex) {
                log.error("Failed to read object.", ex);
            }
        }
        return null;
    }
