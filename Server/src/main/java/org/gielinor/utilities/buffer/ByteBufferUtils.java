package org.gielinor.utilities.buffer;
...
public final class ByteBufferUtils {
    ...
    public static void putString(String string, DataOutputStream dataOutputStream) {
        try {
    ...
    public static void putObject(ByteBuffer buffer, Object o) {
        ByteBuffer b;
        try (ObjectOutputStream out = new ObjectOutputStream(new BufferOutputStream(b = ByteBuffer.allocate(99999)))) {
            out.writeObject(o);
            b.flip();
        } catch (Throwable e) {
            e.printStackTrace();
