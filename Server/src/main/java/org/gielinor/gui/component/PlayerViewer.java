...
public class PlayerViewer extends JPanel {
    ...
    public PlayerViewer(String name) {
        ...
        JLabel lblIp = new JLabel("IP: " + details.getIp());
        lblIp.setBounds(6, 96, 190, 16);
        panel.add(lblIp);

        JLabel lblMac = new JLabel("Mac: " + details.getMacAddress());
        lblMac.setBounds(6, 124, 224, 16);
        panel.add(lblMac);

        JLabel lblCompName = new JLabel("Comp name: " + details.getCompName());
...
//		panel.add(lblCredits);
        ...
        JLabel lblRights = new JLabel("Rights: " + TextUtils.formatDisplayName(details.getRights().toString()));
...
//		panel.add(lblDisplayName);
        ...
        JLabel lblBanned = new JLabel("Banned: " + details.getPortal().getBan().isPunished());
        lblBanned.setBounds(6, 292, 149, 16);
        panel.add(lblBanned);

        JLabel lblMuted = new JLabel("Muted: " + details.getPortal().getMute().isPunished());
     ...
     * @param name      the name.
     */
    public void showContainer(Container container, String name) {
        JPanel panel = new JPanel(new GridLayout(0, 1));
