...
public class BurthorpeTrainNPC extends AbstractNPC {
     ...
     */
    private static final int[] IDS = {/**dummy soldier*/1063, /**sergant*/1061, /**seated soldier*/1066, 1067, 1068, /**other sergant*/1062, /**other soldiers*/1064, 1073, 1074, 1076, 1077 };
    ...
    private final void action() {
        switch (getId()) {
            case 1061://sergant
                sendChat(MESSAGES[RandomUtil.random(MESSAGES.length)]);
                delay = System.currentTimeMillis() + 9000 + RandomUtil.random(1000, 5000);
                final List<NPC> soldiers = RegionManager.getLocalNpcs(this);
                NPC soldier = null;
                while (soldier == null) {
                    soldier = soldiers.get(RandomUtil.random(soldiers.size()));
            ...
            case 1063://soldier.
                faceLocation(getLocation().transform(2, 0, 0));
                animate(RandomUtil.random(2) == 1 ? PUNCH : KICK);
                delay = System.currentTimeMillis() + 3000 + RandomUtil.random(1000, 3000);
                break;
            case 1066:
            case 1067:
            case 1068://seated soldier.
                animate(EAT);
                delay = System.currentTimeMillis() + 3000 + RandomUtil.random(1000, 2000);
                break;
            case 1062:
                final int rand = RandomUtil.random(5);
