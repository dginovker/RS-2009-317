...
public final class OrbViewingInterface extends ComponentPlugin {
     ...
     */
    private static final Location[] FIGHT_PITS = {
        Location.create(2388, 5138, 0), Location.create(2411, 5137, 0),
        Location.create(2409, 5158, 0), Location.create(2384, 5157, 0),
     ...
     */
    private static final Location[] CLAN_WARS = {
        Location.create(3277, 3725, 0), Location.create(3315, 3725, 0),
        Location.create(3316, 3829, 0), Location.create(3277, 3827, 0),
     ...
     */
    private static final Location[][] BOUNTY_HUNTER = {
        { //Low level crater
            Location.create(2752, 5695, 0), Location.create(2816, 5695, 0),
            Location.create(2783, 5783, 0), Location.create(2826, 5785, 0),
            Location.create(2784, 5727, 0)
        },
        { //Mid level crater
            Location.create(3008, 5695, 0), Location.create(3072, 5695, 0),
            Location.create(3039, 5783, 0), Location.create(3082, 5785, 0),
            Location.create(3040, 5727, 0)
        },
        { //High level crater
            Location.create(3264, 5695, 0), Location.create(3328, 5695, 0),
            Location.create(3295, 5783, 0), Location.create(3338, 5785, 0),
    ...
    public Plugin<Object> newInstance(Object arg) throws Throwable {
        ...
        PluginManager.definePlugin(new OptionHandler() {
            ...
            public Plugin<Object> newInstance(Object arg) throws Throwable {
                ...
                ObjectDefinition.forId(11979).getConfigurations().put("option:look-into", this);
    ...
    private void viewOrb(final Player player, final int interfaceId) {
        ...
        player.getInterfaceState().openSingleTab(component);
    }
    ...
    private static void stopViewing(final Player player, boolean close) {
        ...
        player.getAppearance().sync();
        player.getProperties().setTeleportLocation(player.getAttribute("view-location", GameConstants.HOME_LOCATION));
    }
