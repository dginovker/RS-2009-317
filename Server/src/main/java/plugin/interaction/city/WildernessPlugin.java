...
public final class WildernessPlugin extends OptionHandler {
    ...
    public static final class KBDPlugin extends OptionHandler {
        ...
        @Override
        public Plugin<Object> newInstance(Object arg) throws Throwable {
            ObjectDefinition.forId(1765).getConfigurations().put("option:climb-down", this);//ladder to get to kbd lair.
            ObjectDefinition.forId(1766).getConfigurations().put("option:climb-up", this);//ladder to get back up.
            ObjectDefinition.forId(1816).getConfigurations().put("option:pull", this);//kbd entrance lever.
            ObjectDefinition.forId(1817).getConfigurations().put("option:pull", this);//kbd entrance lever.
            return this;
        }
                ...
                case "pull":
                    switch (id) {
                        case 1816://kbd lever.
                            ...
                            player.getTeleporter().send(LOCATIONS[4], TeleportType.NORMAL, Teleport.WILDY_TELEPORT);
                            player.getActionSender().sendMessage("... and teleport into the lair of the King Black Dragon!", 5);
                            break;
                        case 1817:
                            player.getActionSender().sendMessage("You pull the lever...");
                            player.getTeleporter().send(LOCATIONS[5], TeleportType.NORMAL, Teleport.WILDY_TELEPORT);
                            player.getActionSender().sendMessage("... and teleport out of the lair of the King Black Dragon!", 5);
                            break;
                    }
                    break;
            }
