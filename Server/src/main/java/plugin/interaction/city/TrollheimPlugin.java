...
public final class TrollheimPlugin extends OptionHandler {
    ...
    public Plugin<Object> newInstance(Object arg) throws Throwable {
        ...
        NPCDefinition.forId(4092).getConfigurations().put("option:talk-to", this);
        ObjectDefinition.forId(3742).getConfigurations().put("option:read", this);
        ObjectDefinition.forId(3723).getConfigurations().put("option:climb", this);//located in circle area.
        ObjectDefinition.forId(3722).getConfigurations().put("option:climb", this);//located in circle area.
        ObjectDefinition.forId(3748).getConfigurations().put("option:climb", this);
        ObjectDefinition.forId(3790).getConfigurations().put("option:climb", this);//pos=Location.create(2858, 3627, 0)
        ObjectDefinition.forId(3791).getConfigurations().put("option:climb", this);//pos=Location.create(2858, 3627, 0)
        ObjectDefinition.forId(3782).getConfigurations().put("option:open", this);//arena entrance
        ObjectDefinition.forId(3783).getConfigurations().put("option:open", this);//arena entrance
        ObjectDefinition.forId(3762).getConfigurations().put("option:open", this);//secret door.
        ObjectDefinition.forId(4499).getConfigurations().put("option:enter", this);//entrance near golden apple.
        ObjectDefinition.forId(4500).getConfigurations().put("option:enter", this);//entrance near golden apple.
        ObjectDefinition.forId(9303).getConfigurations().put("option:climb", this);//lvl 41.
        ObjectDefinition.forId(3782).getConfigurations().put("option:open", this);//arena entrance.
        ObjectDefinition.forId(3783).getConfigurations().put("option:open", this);//arena entrance.
        ObjectDefinition.forId(3785).getConfigurations().put("option:open", this);//arena exit.
        ObjectDefinition.forId(3786).getConfigurations().put("option:open", this);//arena exit.
        ObjectDefinition.forId(3757).getConfigurations().put("option:enter", this);//arena cave entrance.
        ObjectDefinition.forId(3758).getConfigurations().put("option:exit", this);//arena cave exit.
        ObjectDefinition.forId(9327).getConfigurations().put("option:climb", this);//lvl 64
        ...
        ObjectDefinition.forId(9306).getConfigurations().put("option:climb", this);//lvl 47
        ObjectDefinition.forId(9305).getConfigurations().put("option:climb", this);//lvl 44
        ObjectDefinition.forId(3759).getConfigurations().put("option:enter", this);//top cave.
            ...
            case "open":
                switch (id) {
                    ...
                    case 3783://entrance.
                        ...
                        return true;
                    case 3672:
                        player.getActionSender().sendMessage("You don't know how to open the secret door.");
                        break;
                }
                break;
            case "climb":
                if (!player.getEquipment().containsItem(CLIMBING_BOOTS)) {
                    player.getActionSender().sendMessage("You need Climbing boots to negotiate these rocks.");
                    return true;
                }
                ...
                switch (id) {
                    ...
                    case 3791://rock scalling.
                        ...
                        break;
                    case 3748:
                        player.getActionSender().sendMessage("You climb onto the rock...");
                        if (loc.equals(new Location(2821, 3635, 0))) {
                            ...
                            if (player.getSkills().getLevel(Skills.AGILITY) < 43) {
                                player.getActionSender().sendMessage("You need an Agility level of 43 in order to climb this mountain side.");
                                return true;
                            }
                        ...
                        player.getActionSender().sendMessage("...and step down the other side.");
                        break;
                    case 3803:
                    case 3804:
                        if (player.getSkills().getLevel(Skills.AGILITY) < 43) {
                    ...
                    case 9306:
                        if (player.getSkills().getLevel(Skills.AGILITY) < 47) {
                            player.getActionSender().sendMessage("You need an Agility level of 47 in order to climb this mountain side.");
                            return true;
                        }
                    ...
                    case 9303:
                        if (player.getSkills().getLevel(Skills.AGILITY) < 41) {
                            player.getActionSender().sendMessage("You need an Agility level of 41 in order to climb this mountain side.");
                            return true;
                        }
                    ...
                    case 9305:
                        if (player.getSkills().getLevel(Skills.AGILITY) < 44) {
                            player.getActionSender().sendMessage("You need an Agility level of 44 in order to climb this mountain side.");
                            return true;
                        }
                    ...
                    case 9327:
                        if (player.getSkills().getLevel(Skills.AGILITY) < 64) {
                            player.getActionSender().sendMessage("You need an Agility level of 64 in order to climb this mountain side.");
                            return true;
                        }
    ...
    public static final class TenzingDialogue extends DialoguePlugin {
         ...
         */
        private static final Item COINS = new Item(Item.COINS, 12);
        ...
        public boolean handle(int interfaceId, OptionSelect optionSelect) {
            switch (stage) {
                ...
                case 12:
                    ...
                    break;
                case 13:
                    if (!player.getInventory().hasRoomFor(CLIMBING_BOOTS)) {
                    ...
                    if (player.getInventory().add(CLIMBING_BOOTS)) {
                        ...
                        player.getActionSender().sendMessage("Tenzing has given you some Climbing boots.");
                    }
                    stage = 50;
                    break;
                case 20:
    ...
    public final class TrollNPC extends AbstractNPC {
        ...
        @Override
        public int[] getIds() {
            return new int[]{ 936, 937, 938, 939, 940, 941, 942, 4143 };
        }
