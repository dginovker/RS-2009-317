    ...
    public boolean handle(final Player player, Node node, String option) {
        ...
        switch (id) {
            ...
            case 152:
                ...
                player.getActionSender().sendMessage("You dig throug the compost...");
                if (!player.getInventory().containsItem(KEY)) {
                    ...
                    player.getActionSender().sendMessage("... but you find nothing of interest.");
                }
                break;
            case 153:
                player.lock(3);
                ...
                public boolean pulse() {
                    switch (counter++) {
                        ...
                        case 5:
                            ...
                            break;
                        case 6:
                            ForceMovement movement = new ForceMovement(player, player.getLocation(), destination, ForceMovement.WALK_ANIMATION);
                            movement.run(player, 16);
                            break;
                        case 8:
