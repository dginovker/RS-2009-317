...
public final class VarrockNodePlugin extends OptionHandler {
    ...
    public Plugin<Object> newInstance(Object arg) throws Throwable {
        ObjectDefinition.forId(24357).getConfigurations().put("option:climb-up", this);//juliet house stairs.
    ...
    public boolean handle(final Player player, Node node, String option) {
        ...
        switch (id) {
            ...
            case 28094:
                ...
                break;
            case 23636:
                player.getInterfaceState().open(new Component(531));
                break;
            case 1749:
            ...
            case 24428:
                ...
                return false;
            case 9662:
                if (!player.getInventory().hasRoomFor(SPADE)) {
