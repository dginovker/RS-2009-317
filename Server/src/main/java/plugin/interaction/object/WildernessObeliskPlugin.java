...
import org.gielinor.game.world.update.flag.chunk.GraphicUpdateFlag;
    ...
    public boolean handle(final Player player, final Node node, String option) {
        ...
        World.submit(new Pulse(6, player) {
            ...
            public boolean pulse() {
                ...
                int index = RandomUtil.random(Obelisk.values().length);
                ...
                for (Player player : RegionManager.getLocalPlayers(center, 1)) {
                    player.getActionSender().sendMessage("Ancient magic teleports you somewhere in the wilderness.");
