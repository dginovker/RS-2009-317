...
public final class WildernessInterfacePlugin extends ComponentPlugin {
    ...
    public Plugin<Object> newInstance(Object arg) throws Throwable {
        ComponentDefinition.put(46900, this);
        return this;
    }
    ...
    public boolean handle(Player player, Component component, int opcode, int button, int slot, int itemId) {
        switch (button) {
            case 46902:
                ...
                return true;
            case 46911:
                player.getInterfaceState().set(InterfaceConfiguration.WILDERNESS_WARNING, player.getInterfaceState().get(InterfaceConfiguration.WILDERNESS_WARNING) == 1 ? 0 : 1, true);
                return true;
            default:
                player.getInterfaceState().close();
                return true;
