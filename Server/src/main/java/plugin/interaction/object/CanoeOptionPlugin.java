...
/**
 * Represents the option handler plugin that will handle all node interactions related to canoes.
 *
 * @author 'Vexia
 * @version 1.0
 */
public final class CanoeOptionPlugin extends OptionHandler {
    ...
    public Plugin<Object> newInstance(Object arg) throws Throwable {
        final String[] options = new String[]{
            "chop-down", "shape-canoe", "float canoe", "paddle canoe", "float log", "float waka", "paddle log"
        };
    ...
    public Location getDestination(Node node, Node n) {
        ...
        } else if (object.getLocation().equals(new Location(3200, 3341, 0))) {//champions guild
            if (extension.getStage() == 0) {
