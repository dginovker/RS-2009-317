...
public final class WaterSourcePlugin extends UseWithHandler {
    ...
    private static final int[] OBJECTS = new int[]{
        7143, 5125,
        23920, 35469, 24265, 6827, 153, 879, 880, 2864,
        6232, 10436, 10437, 10827, 11007, 11759, 21764, 22973,
        24161, 24214, 24265, 28662, 30223, 30820, 34579, 36781,
        873, 874, 4063, 6151, 8699, 9143, 9684, 10175, 12279, 12974,
        13563, 13564, 14868, 14917, 15678, 16704, 16705, 20358, 22715,
        24112, 24314, 25729, 25929, 26966, 29105, 33458, 34082, 34411,
        34496, 34547, 34566, 35762, 36971, 37154, 37155, 878, 884, 3264,
        3305, 3359, 3485, 4004, 4005, 6097, 6249, 6549, 8747, 8927, 11793,
        12201, 12897, 24166, 26945, 31359, 32023, 32024, 34576, 35671 };
    ...
    public boolean handle(NodeUsageEvent event) {
        ...
        recipient.handle(event.getPlayer());
        return true;
    }
    ...
    public enum WaterRecipient {
        ...
        BOWL_OSRS(new Item(21923), new Item(21921)),
        CLAY(new Item(434), new Item(1761), "You mix the clay and water. You now have some soft, workable clay."),
        WATERIN_CAN(new Item(5331), new Item(5340), "You fill the watering can."),
        WATERIN_CAN7(new Item(5339), new Item(5340), "You fill the watering can."),
        WATERIN_CAN6(new Item(5338), new Item(5340), "You fill the watering can."),
        WATERIN_CAN5(new Item(5337), new Item(5340), "You fill the watering can."),
        WATERIN_CAN4(new Item(5336), new Item(5340), "You fill the watering can."),
        WATERIN_CAN3(new Item(5335), new Item(5340), "You fill the watering can."),
        WATERIN_CAN2(new Item(5334), new Item(5340), "You fill the watering can."),
        WATERIN_CAN1(new Item(5333), new Item(5340), "You fill the watering can.");
            ...
            player.getPulseManager().run(new Pulse(2, player) {
                ...
                public boolean pulse() {
                    if (player.getInventory().remove(getRequired())) {
                        ...
                        player.getActionSender().sendMessage(getMessage());
