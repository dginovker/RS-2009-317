...
public class TeleTabsOptionPlugin extends OptionHandler {
    ...
    public enum TeleTabs {
        ...
        LUMBRIDGE_TELEPORT(8008, TeleportLocation.LUMBRIDGE.getLocation(), 41),
        FALADOR_TELEPORT(8009, TeleportLocation.EAST_VARROCK.getLocation(), 47),
        CAMELOT_TELEPORT(8010, TeleportLocation.CAMELOT.getLocation(), 55.5),
        ADDOUGNE_TELEPORT(8011, TeleportLocation.EAST_ADROUGONE.getLocation(), 61),
        WATCH_TOWER_TELEPORT(8012, TeleportLocation.WIZARD_WATCH_TOWER.getLocation(), 68);
