...
public final class IceSpells extends CombatSpell {
     ...
     * The barrage orb GFX.
     */
    private static final Graphics BARRAGE_ORB = new Graphics(119, 96); //1677 for the real one, but old school didn't have it.
    ...
    private IceSpells(SpellType type, int level, double baseExperience, int impactSound, Animation anim, Graphics start, Projectile projectile, Graphics end, Item... runes) {
        super(type, SpellBook.ANCIENT, level, baseExperience, 1111, impactSound, anim, start, projectile, end, runes);
    }
    ...
    public Plugin<SpellType> newInstance(SpellType arg) throws Throwable {
        SpellBook.ANCIENT.register(12861, new IceSpells(SpellType.RUSH, 58, 34.0, 173, new Animation(1978, Priority.HIGH), null, RUSH_PROJECTILE, RUSH_END, Runes.DEATH_RUNE.getItem(2), Runes.CHAOS_RUNE.getItem(2), Runes.WATER_RUNE.getItem(2)));
        SpellBook.ANCIENT.register(12881, new IceSpells(SpellType.BURST, 70, 40.0, 1126, new Animation(1979, Priority.HIGH), null, BURST_PROJECTILE, BURST_END, Runes.DEATH_RUNE.getItem(2), Runes.CHAOS_RUNE.getItem(4), Runes.WATER_RUNE.getItem(4)));
        SpellBook.ANCIENT.register(12871, new IceSpells(SpellType.BLITZ, 82, 46.0, 169, new Animation(1978, Priority.HIGH), BLITZ_START, null, BLITZ_END, Runes.BLOOD_RUNE.getItem(2), Runes.DEATH_RUNE.getItem(2), Runes.WATER_RUNE.getItem(3)));
        SpellBook.ANCIENT.register(12891, new IceSpells(SpellType.BARRAGE, 94, 52.0, 1125, new Animation(1979, Priority.HIGH), null, BARRAGE_PROJECTILE, BARRAGE_END, Runes.BLOOD_RUNE.getItem(2), Runes.DEATH_RUNE.getItem(4), Runes.WATER_RUNE.getItem(6)));
        return this;
    }
