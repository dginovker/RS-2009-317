...
/**
 * Handles the Magic shortbow and its (i) version's special attack.
 *
 * reference:
 *  - http://oldschoolrunescape.wikia.com/wiki/Special_attacks
 *  - http://oldschoolrunescape.wikia.com/wiki/Magic_shortbow
 *  - http://oldschoolrunescape.wikia.com/wiki/Magic_shortbow_(i)
 *
 * @author Emperor
 * @version 1.0
 */
public final class SnapshotSpecial extends RangeSwingHandler implements Plugin<Object> {

    private static final int SPECIAL_ENERGY = 55;
    private static final Animation ANIMATION = new Animation(1074, Priority.HIGH);
    private static final Graphics GRAPHIC = new Graphics(256, 96);
    ...
    @Override public void impact(final Entity entity, final Entity victim, final BattleState state) {
