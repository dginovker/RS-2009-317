...
public class PiePlugin extends Food {
    ...
    public String getEatMessage() {
        return "You eat " + (getItem().getName().toLowerCase().contains("half") ? getItem().getName().toLowerCase() : "half " + (TextUtils.isPlusN(getItem().getName().toLowerCase()) ? "an " : "a ") + getItem().getName().toLowerCase()) + ".";
    }
