...
public final class GenieRandomEvent extends AntiMacroEvent {
    ...
    public boolean start(Player player, boolean login, Object... args) {
        if (player.getInventory().contains(new Item(2528))) {
            return false;
        }
        super.init(player);
    ...
    public final class GenieDialogue extends AntiMacroDialogue {
        ...
        public boolean open(Object... args) {
            if (super.open(args)) {
                npc("Ah, so you are there " + player.getAntiMacroHandler().getEvent().getGenderPrefix() + ". I'm so glad you", "summoned me. Please take this lamp and make your", "wish!");
            }
            return true;
        }
