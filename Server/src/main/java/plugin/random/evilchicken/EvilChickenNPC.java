...
public final class EvilChickenNPC extends AbstractNPC {
    ...
    private static final CombatSwingHandler HANDLER = new MagicSwingHandler() {
        ...
        public int swing(Entity entity, Entity victim, BattleState state) {
            entity.sendChat(RandomUtil.getRandomElement(MESSAGES).replace("@name@", victim.getUsername()));
    ...
    public void finalizeDeath(Entity killer) {
        ...
        if (killer instanceof Player) {
            ...
            GroundItemManager.create(new GroundItem(new Item(314, RandomUtil.random(32, 750)), getLocation(), killer.asPlayer()));
        }
    }
