...
public final class GertrudeDialogue extends DialoguePlugin {
     ...
     */
    private static final Item COINS = new Item(Item.COINS, 100);
    ...
    public boolean handle(int interfaceId, OptionSelect optionSelect) {
        ...
        switch (stage) {
            ...
            case 320:
                ...
                break;
            case 321:
                interpreter.sendPlaneMessage("Gertrude gives you a hug.");
                npc.face(player);
                stage = 322;
                break;
            case 322:
            ...
            case 328:
                ...
                break;
            case 329:
                interpreter.sendPlaneMessage("Gertrude gives you a kitten.");
                stage = 330;
                break;
            case 330:
...
//					if (player.getFamiliarManager().getFamiliar().getDetails() instanceof PetDetails) {
//						final PetDetails details = ((PetDetails) player.getFamiliarManager().getFamiliar().getDetails());
...
//				}
                ...
                switch (optionSelect) {
                    case TWO_OPTION_ONE:
                        if (!player.getInventory().contains(Item.COINS, 100)) {
                            player.getActionSender().sendMessage("You need a 100 coins to buy a kitten.");
                            end();
                            break;
                        } else {
                            if (player.getInventory().freeSlots() == 0) {
            ...
            case 905:
                ...
                if (player.getInventory().remove(COINS)) {
                    interpreter.sendPlaneMessage("Gertrude gives you another kitten.");
                    stage = 906;
