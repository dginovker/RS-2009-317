...
import org.gielinor.game.content.skill.free.cooking.dairy.DairyChurnPulse;
import org.gielinor.game.content.skill.free.cooking.dairy.DairyProduct;
...
public final class DairyChurnDialogue extends DialoguePlugin {
    ...
    public boolean open(Object... args) {
        player.getInterfaceState().openChatbox(new Component(74));
        return true;
    }
