    ...
    public boolean handle(int interfaceId, OptionSelect optionSelect) {
        ...
        switch (stage) {
            ...
            case 50:
                ...
                break;
            case 51:
                interpreter.sendDialogues(player, FacialExpression.NO_EXPRESSION, "How do you have a party in " + Constants.SERVER_NAME + "?");
                stage = 52;
                break;
            case 52:
            ...
            case 60:
                ...
                break;
            case 61:
                interpreter.sendDialogues(npc, FacialExpression.NO_EXPRESSION, "Any items in the chest will be dropped inside the balloons", "when you pull the lever.");
                stage = 62;
                break;
            case 62:
