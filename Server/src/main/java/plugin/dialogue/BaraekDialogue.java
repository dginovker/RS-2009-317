...
public final class BaraekDialogue extends DialoguePlugin {
     ...
     */
    private static final Item BUY_COINS = new Item(Item.COINS, 12);

    /**
     * Represents the coins item.
     */
    private static final Item COINS = new Item(Item.COINS, 20);
     ...
     *
     * @param optionSelect the button id.
     */
    public void handleFurSelling(OptionSelect optionSelect) {
        switch (stage) {
            case 20:
     ...
     *
     * @param optionSelect the buttonId.
     */
    public void handleFurBuy(OptionSelect optionSelect) {
        switch (stage) {
            case 80:
