    ...
    public boolean handle(int interfaceId, OptionSelect optionSelect) {
        switch (stage) {
            ...
            case 10:
                ...
                break;
            case 11:
                if (!player.getInventory().contains(Item.COINS, 875)) {
            ...
            case 31:
                ...
                break;
            case 32:
                Item item = new Item(Item.COINS, 875);
                if (player.getInventory().remove(item)) {
                    player.getActionSender().sendMessage("You pay Saniboch 875 coins.");
            ...
            case 35:
                ...
                stage = 12;
                handle(interfaceId, OptionSelect.THREE_OPTION_ONE);
                break;
            case 36:
