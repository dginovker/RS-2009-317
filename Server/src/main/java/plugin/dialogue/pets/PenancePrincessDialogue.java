 ...
 * @author Harry
 */
public class PenancePrincessDialogue extends DialoguePlugin {

    public PenancePrincessDialogue() {
    }

    private PenancePrincessDialogue(Player player) {
        super(player);
    }

    @Override
    public DialoguePlugin newInstance(Player player) {
        return new PenancePrincessDialogue(player);
    }
