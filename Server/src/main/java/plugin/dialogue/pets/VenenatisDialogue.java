 ...
 * @author Harry
 */
public class VenenatisDialogue extends DialoguePlugin {

    public VenenatisDialogue() {
    }

    private VenenatisDialogue(Player player) {
        super(player);
    }

    @Override
    public DialoguePlugin newInstance(Player player) {
        return new VenenatisDialogue(player);
    }
