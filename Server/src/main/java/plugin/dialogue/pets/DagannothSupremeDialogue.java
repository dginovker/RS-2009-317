 ...
 * @author Harry
 */
public class DagannothSupremeDialogue extends DialoguePlugin {

    public DagannothSupremeDialogue() {
    }

    private DagannothSupremeDialogue(Player player) {
        super(player);
    }

    @Override
    public DialoguePlugin newInstance(Player player) {
        return new DagannothSupremeDialogue(player);
    }
    ...
    public boolean handle(int interfaceId, OptionSelect optionSelect) {
        switch (stage) {
            ...
            case 1:
                player("Maybe next time I'll add", "your brothers to my collection.");
                stage = 0xBABE;
                break;
