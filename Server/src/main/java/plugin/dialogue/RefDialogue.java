 ...
 * @author 'Vexia
 */
public final class RefDialogue extends DialoguePlugin {
     ...
     */
    public RefDialogue(final Player player) {
        super(player);
    }

    @Override
    public DialoguePlugin newInstance(Player player) {
        return new RefDialogue(player);
    }
    ...
    public boolean handle(int interfaceId, OptionSelect optionSelect) {
        switch (stage) {
            ...
            case 17:
                ...
                break;
            case 18:
                interpreter.sendPlaneMessage("The Referee sighs, rolls his eyes and continues....");
                stage++;
                break;
            case 19:
