    ...
    public boolean handle(int interfaceId, OptionSelect optionSelect) {
        ...
        switch (stage) {
            ...
            case 13:
                ...
                break;
            case 14:
                interpreter.sendDialogues(npc, FacialExpression.NO_EXPRESSION, "Yeash! Me and my cousins were having a great", "party by the river when we decided to have a", " game of 'Smack The Tree'");
                stage = 15;
                break;
            case 15:
                interpreter.sendDialogues(player, FacialExpression.NO_EXPRESSION, "Smack the Tree?");
                stage = 16;
                break;
            case 16:
