    ...
    public boolean handle(int interfaceId, OptionSelect optionSelect) {
        switch (stage) {
            ...
            case 101:
                ...
                break;
            case 102:
                interpreter.sendDialogues(npc, null, "No, you're carrying " + player.getInventory().getCount(NOTED_SILK) + " bits of paper that say they", "can be exchanged for silk at a bank or general store.", "I'm not buying those. Fetch me some real silk, then", "we'll trade.");
                stage = 103;
                break;
            case 103:
