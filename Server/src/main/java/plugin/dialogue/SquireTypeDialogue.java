    ...
    public boolean handle(int interfaceId, OptionSelect optionSelect) {
        switch (stage) {
            ...
            case 22:
                ...
                break;
            case 23:
                npc("The novice.");// + (npc.getId() == 3802 ? "novice" : npc.getId() == 6140 ? "intermediate" : "veteran") + ".");
                stage = 24;
                break;
            case 24:
            ...
            case 25:
                ...
                break;
            case 26:
                npc("early if they get full. If you'd be willing to help us then", "just wait in the lander and we'll launch it as soon as it's", "ready. However you will need a combat level of " + /*(npc.getId() == 3802 ? "40" : npc.getId() == 6140 ? "70" : "100")*/ "40" + " to", "use this lander.");
                stage = 27;
                break;
            case 27:
                end();
