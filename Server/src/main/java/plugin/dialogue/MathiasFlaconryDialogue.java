        ...
        switch (stage) {
            ...
            case 95:
                ...
                if (player.getInventory().contains(Item.COINS, 500)) {
                    ...
                    interpreter.sendPlaneMessage("The falconer gives you a large leather glove and brings one of the", "smaller birds over to land on it.");
                    stage = 97;
                } else {
                    end();
                    player.getActionSender().sendMessage("You need 500 gold coins.");
                }
                break;
            case 97:
