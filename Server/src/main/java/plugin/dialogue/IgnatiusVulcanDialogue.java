...
public final class IgnatiusVulcanDialogue extends DialoguePlugin {
    ...
    private static final Logger log = LoggerFactory.getLogger(IgnatiusVulcanDialogue.class);
    ...
    public static void createFire(final NPC npc, final Location location) {
        ...
        if (RegionManager.getObject(location) == null) {
            ...
            ObjectBuilder.add(fire, RandomUtil.random(100, 130));
    ...
    public void init() {
        ...
        try {
            ...
            log.error("Failed to init Ignatius Vulcan dialogue.", t);
        }
    }
    ...
    public boolean handle(int interfaceId, OptionSelect optionSelect) {
        switch (stage) {
            ...
            case 100:
                ...
                break;
            case 101:
                npc("Certainly! Right when you give me 99,000 coins.");
                stage = 102;
                break;
            case 102:
    ...
    public final class IgnatiusVulcanNPC extends AbstractNPC {
        ...
        public void tick() {
            if (lastFire < World.getTicks()) {
                ...
                lastFire = World.getTicks() + RandomUtil.random(50, 200);
            }
            super.tick();
        }
