    ...
    public boolean open(Object... args) {
        if (args.length == 3) {
            ...
            if (type == 0) {//lost
                ...
                interpreter.sendDialogues(3781, FacialExpression.NO_EXPRESSION, "Congratulations! You managed to destroy all the portals!", "However, you did not succeed in reaching the required", "amount of damage dealt we cannot grant you a reward.");
                stage = 101;
            }
            return true;
        }
    ...
    public boolean handle(int interfaceId, OptionSelect optionSelect) {
        switch (stage) {
            ...
            case 100:
                ...
                interpreter.sendPlaneMessage(BLUE + "You now have " + RED + "" + player.getSavedData().getActivityData().getPestPoints() + "" + BLUE + " Void Knight Commendation points!</col>", "You can speak to a Void Knight to exchange your points for", "rewards.");
                stage = 101;
                break;
            case 101:
                end();
