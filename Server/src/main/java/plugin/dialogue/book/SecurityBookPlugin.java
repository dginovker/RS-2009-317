...
public final class SecurityBookPlugin extends Book {
    ...
    public SecurityBookPlugin(final Player player) {
        super(player, Constants.SERVER_NAME + " Account Security", 9003, PAGES);
    }
