        ...
        switch (stage) {
            ...
            case 100:
                ...
                if (player.getInventory().remove(COINS)) {
                    ...
                    player.getActionSender().sendMessage("You buy a Asgarnian Ale.");
                    stage = 101;
                } else {
                    end();
                    player.getActionSender().sendMessage("You need 3 gold coins to buy ale.");
                }
                break;
            case 101:
                end();
            ...
            case 120:
                if (player.getInventory().remove(COINS)) {
                    ...
                    interpreter.sendDialogues(player, FacialExpression.NO_EXPRESSION, "Thanks, " + npc.getName() + ".");
                    player.getActionSender().sendMessage("You buy a Wizard's Mind Bomb.");
                    stage = 101;
                } else {
                    end();
                    player.getActionSender().sendMessage("You need 3 gold coins to buy ale.");
            ...
            case 130:
                if (player.getInventory().remove(COINS)) {
                    ...
                    interpreter.sendDialogues(player, FacialExpression.NO_EXPRESSION, "Thanks, " + npc.getName() + ".");
                    player.getActionSender().sendMessage("You buy a Dwarven Stout.");
                    stage = 101;
                } else {
                    end();
                    player.getActionSender().sendMessage("You need 3 gold coins to buy ale.");
            ...
            case 190:
                if (player.getInventory().contains(1919, 1)) {
                    player.getInventory().add(new Item(Item.COINS, 2 * player.getInventory().getCount(new Item(1919))));
                    player.getInventory().remove(new Item(1919, player.getInventory().getCount(new Item(1919))));
