    ...
    public boolean handle(int interfaceId, OptionSelect optionSelect) {
        ...
        switch (stage) {
            ...
            case 2:
                ...
                break;
            case 3:
                interpreter.sendDialogues(783, FacialExpression.NO_EXPRESSION, "He can you know!");
                stage = 4;
                break;
            case 4:
                ...
                break;
            case 5:
                interpreter.sendPlaneMessage("The boy begins to jump around with his fists up.", "You wonder what sort of desperado he'll grow up to be.");
                stage = 6;
                break;
            case 6:
                end();
