...
//			if (player.getSkills().getLevel(Skills.SUMMONING) < ((PetDetails) f.getDetails()).getPet().getSummoningLevel() + 10) {
//				interpreter.sendDialogues(npc, null, "Grumble...!");
//				int lvl = ((PetDetails) f.getDetails()).getPet().getSummoningLevel() + 10;
//				if (lvl > 99) {
//					player.getActionSender().sendMessage("It is impossible to talk to this pet.");//dragon, chamerelon, monket..etc
//					return true;
//				}
//				player.getActionSender().sendMessage("You need a summoning level of " + lvl +  " in order to communicate with your pet.");
//				stage = 99;
//				return true;
//			}
//		}
        stage = RandomUtil.random(1, 3);
        switch (stage) {
            case 1:
