...
public final class ShantayDialogue extends DialoguePlugin {
    ...
    public boolean open(Object... args) {
        if (args.length == 2) {
            player.getActionSender().sendMessage("Shantay saunters over to talk with you.");
    ...
    public boolean handle(int interfaceId, OptionSelect optionSelect) {
        switch (stage) {
            ...
            case 21:
                ...
                Shops.SHANTAY_PASS_SHOP.open(player);
                break;
            case 700:
            ...
            case 701:
                ...
                break;
            case 702:
                player.getActionSender().sendMessage("The guards arrest you and place you in the jail.");
                close();
                player.lock(10);
                World.submit(new Pulse(3, player) {
                    ...
                    public boolean pulse() {
                        player.saveAttribute("shantay-jail", true);
            ...
            case 705:
                if (player.getInventory().remove(new Item(Item.COINS, 5))) {
                    player.getActionSender().sendMessage("You hand over the five gold pieces to Shantay.");
                    player.getActionSender().sendMessage("Shantay unlocks the door to the cell.");
            ...
            case 804:
                ...
                break;
            case 805:
                player.getActionSender().sendMessage("You find yourself in a prison.");
                player.removeAttribute("shantay-jail");
