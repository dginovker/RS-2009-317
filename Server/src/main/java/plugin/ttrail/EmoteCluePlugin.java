...
public final class EmoteCluePlugin extends EmoteClueScroll {
    ...
    /**
     * Constructs a new <code>EmoteCluePlugin</code> <code>Object</code>
     */
    ...
    public Plugin<Object> newInstance(Object arg) throws Throwable {
        ...
        register(new EmoteCluePlugin("ardgoune-mill-clap", 2691,
            ClueLevel.EASY, emote, new int[][]{ { 640 }, { 4300 }, { 5525 } },
            "Clap on the top level of the<br>mill, north of East Ardougne.<br>Equip a blue gnome robe top,<br>HAM robe bottom and an<br>unenchanted tiara.",
            new ZoneBorders(2628, 3382, 2636, 3390)));
        ...
        register(new EmoteCluePlugin("seers-party-dance", 2696, ClueLevel.EASY, emote, new int[][]{ { 1157 }, { 1119 }, { 1081 } }, "Dance in the Party<br>Room.<br>Equip a steel full<br>helmet, steel<br>platebody and an iron<br>plateskirt.", new ZoneBorders(2730, 3462, 2745, 3476)));
        ...
        register(new EmoteCluePlugin("beehive-jump", 2703, ClueLevel.EASY, Emote.JUMP_FOR_JOY, new int[][]{ { 1833 }, { 648 }, { 1353 } }, "Jump for joy at the beehives.<br>Equip a desert shirt, green<br>gnome robe bottoms and a<br>steel axe.", new ZoneBorders(2752, 3437, 2766, 3449)));
        register(new EmoteCluePlugin("yanille-jump", 2704, ClueLevel.MEDIUM, Emote.JUMP_FOR_JOY, Emote.JIG, new int[][]{ { 1757 }, { 1145 }, { 6324 } }, "Jump for joy in Yanille<br>bank. Dance a jig before you<br>talk to me.<br>Equip a brown apron,<br>adamantite medium helmet<br>and snakeskin chaps.", new ZoneBorders(2609, 3088, 2614, 3097)));
        register(new EmoteCluePlugin("tzhaar-jump", 2705, ClueLevel.MEDIUM, Emote.JUMP_FOR_JOY, Emote.SHRUG, new int[][]{ { 1295 }, { 2499 }, { 4095 } }, "Jump for joy in the TzHaar<br>sword shop. Shrug before you<br>talk to me.<br>Equip a Steel longsword,<br>Blue D'hide body and blue<br>mystic gloves.", new ZoneBorders(2477, 5144, 2480, 5147)));
        emote = Emote.LAUGH;
        ...
        emote = Emote.SALUTE;
        // TODO make banana salute so it won't work if u are wearing anything on chest or legs
        ...
        // register(new EmoteCluePlugin("observatory-think", 2727, ClueLevel.MEDIUM, emote, Emote.SPIN, new int[][]{{1109}, {1099}, {1698}}, "Think in the centre of<br>the Observatory. Spin<br>before you talk to me.<br>Equip a mithril chain<br>body, green<br>dragonhide chaps and<br>a ruby amulet.", new ZoneBorders(2439, 3160, 2442, 3163)));
        emote = Emote.WAVE;
        ...
        register(new EmoteCluePlugin("castle-wars-yawn", 2739, ClueLevel.MEDIUM, emote, Emote.SHRUG, new int[][]{ { 1698 }, { 1329 }, { 4315, 4316, 4317, 4318, 4319, 4320, 4321, 4322, 4323, 4324, 4325, 4326, 4327, 4328, 4329, 4330, 4331, 4332, 4333, 4334, 4335, 4336, 4337, 4338, 4339, 4340, 4341, 4342, 4343, 4344, 4345, 4346, 4347, 4348, 4349, 4350, 4351, 4352, 4353, 4354, 4355, 4356, 4357, 4358, 4359, 4360, 4361, 4362, 4363, 4364, 4365, 4366, 4367, 4368, 4369, 4370, 4371, 4372, 4373, 4374, 4375, 4376, 4377, 4378, 4379, 4380, 4381, 4382, 4383, 4384, 4385, 4386, 4387, 4388, 4389, 4390, 4391, 4392, 4393, 4394, 4395, 4396, 4397, 4398, 4399, 4400, 4401, 4402, 4403, 4404, 4405, 4406, 4407, 4408, 4409, 4410, 4411, 4412, 4413, 4414, 10638 } }, "Yawn in the Castle<br>Wars lobby. Shrug<br>before you talk to me.<br>Equip ruby amulet, a<br>mithril scimitar and a<br>Wilderness cape.", new ZoneBorders(2435, 3081, 2446, 3098)));
