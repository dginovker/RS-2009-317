...
public class SpiritCobraNPC extends Familiar {
    ...
    protected boolean specialMove(FamiliarSpecial special) {
        ...
        if (egg == null) {
            owner.getActionSender().sendMessage("You can't use the special move on this item.");
            return false;
        }
    ...
    public enum Egg {
        ...
        SARATRICE(new Item(10533), new Item(12113)),
        ZAMATRICE(new Item(10532), new Item(12115)),
        GUTHATRICE(new Item(10531), new Item(12111)),
        CORACATRICE(new Item(11964), new Item(12119)),
        PENGATRICE(new Item(12483), new Item(12117)),
        VULATRICE(new Item(11695), new Item(12121));
