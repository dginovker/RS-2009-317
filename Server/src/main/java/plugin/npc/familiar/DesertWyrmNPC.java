    ...
    public void configureFamiliar() {
        PluginManager.definePlugin(new OptionHandler() {
            ...
            public boolean handle(final Player player, final Node node, String option) {
                ...
                if (rock == null) {
                    player.getActionSender().sendMessage("There are no rocks around here for the desert wyrm to mine from!");
                    return true;
                }
                ...
                World.submit(new Pulse(1, player, familiar) {
