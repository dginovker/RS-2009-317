...
public final class GoblinVillageNPC extends AbstractNPC {
     ...
     */
    private static final int[] ID = {/**r*/4483, /**g*/4488,/**g*/4489, /**r*/4484, /**g*/4491, /**r*/4485, /**g*/4486, /**g*/4492, /**g*/4487, /**r*/4481, /**r*/4479, /**r*/4482, /**r*/4480 };
    ...
    public void tick() {
        ...
        if (delay < System.currentTimeMillis() && !getProperties().getCombatPulse().isAttacking()) {
            final int rand = RandomUtil.random(1, 4);
            if (rand == 2) {
            ...
            final int rand = RandomUtil.random(3);
            if (rand != 1) {
                return;
            }
            ...
            if (goblin && RandomUtil.random(0, 3) == 2) {
                sendChat(green ? GREEN_MESSAGES[RandomUtil.random(GREEN_MESSAGES.length)] : RED_MESSAGES[RandomUtil.random(RED_MESSAGES.length)]);
            }
        }
    }
