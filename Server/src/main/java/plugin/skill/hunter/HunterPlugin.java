...
import org.gielinor.game.content.skill.member.hunter.TrapNode;
import org.gielinor.game.content.skill.member.hunter.TrapWrapper;
import org.gielinor.game.content.skill.member.hunter.Traps;
import org.gielinor.game.content.skill.member.hunter.bnet.BNetNode;
    ...
    public static final class HunterItemPlugin extends OptionHandler {
        ...
        public enum ReleaseType {
            ...
            public void release(final Player player, final Item item) {
                ...
                player.getActionSender().sendMessage("You release the " + item.getName().toLowerCase() + (multiple ? "s" : "") + " and " + (multiple ? "they" : "it") + " bound" + (!multiple ? "s" : "") + " away.", 1);
            }
