...
/**
 * The Camelot log balance shortcut near the Sinclair mansion.
 *
 * @author <a href="https://Gielinor.org">Gielinor Logan G.</a>
 */
public class CamelotLogBalance extends OptionHandler {
    ...
    public Plugin<Object> newInstance(Object arg) throws Throwable {
        ObjectDefinition.forId(9324).getConfigurations().put("option:walk-across", this);
        ObjectDefinition.forId(9322).getConfigurations().put("option:walk-across", this);
        return this;
    }
}
