...
public class MonkeyBarShortcut extends AgilityShortcut {
     ...
     */
    private static final Location[][] MBAR_LOCATIONS = new Location[][]{
        { new Location(3120, 9969, 0), Location.create(3121, 9969, 0) },
        { new Location(3119, 9969, 0), Location.create(3120, 9969, 0) },
        { new Location(3120, 9964, 0), Location.create(3121, 9964, 0) },
        { Location.create(3120, 9963, 0), Location.create(3120, 9964, 0) },
        { new Location(2598, 9489, 0), new Location(2597, 9488, 0) },
        { new Location(2598, 9489, 0), new Location(2600, 9488, 0) },
        { new Location(2598, 9494, 0), new Location(2597, 9495, 0) },
        { new Location(2599, 9494, 0), new Location(2600, 9495, 0) } };
    ...
    public MonkeyBarShortcut() {
        super(new int[]{ 2320 }, 1, 14.0, "swing across");
    }
            ...
            public boolean pulse() {
                if (++count == 1) {
                    ...
                    if (failed) {
                        ...
                        AgilityHandler.fail(player, 2, new Location(2599, 9564, 0), Animation.create(768), RandomUtil.random(1, 3), null);
                        return true;
                    }
