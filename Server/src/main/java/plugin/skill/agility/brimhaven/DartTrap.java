        ...
        World.submit(new Pulse(2, e) {
            ...
            public boolean pulse() {
                if (++count == 1) {
                    ...
                    if (failed) {
                        player.getActionSender().sendMessage("You were hit by some darts, something on them makes you feel dizzy!");
                        player.getSkills().updateLevel(Skills.AGILITY, -(2 + RandomUtil.randomize(2)), 0);
                        return true;
                    }
                    setDelay(2);
