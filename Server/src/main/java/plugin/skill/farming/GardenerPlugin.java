...
import org.gielinor.game.content.skill.member.farming.FarmingItemHolder;
...
public final class GardenerPlugin extends OptionHandler {
    ...
    public static final class GardenerDialogue extends DialoguePlugin {
        ...
        /**
         * Represents the items needed to remove a tree.
         */
        private static final Item TREE_COINS = new Item(Item.COINS, 200);
                    ...
                    switch (optionSelect) {
                        case TWO_OPTION_ONE:
                            ...
                            if (player.getInventory().remove(TREE_COINS)) {
                                interpreter.sendPlaneMessage("The gardener obligingly removes your tree.");
         ...
         */
        private void pay() {
            if (!canProtect() || !player.getInventory().containsItem(getItem())) {
                return;
            }
            if (player.getInventory().remove(getItem())) {
        ...
        private void purchase(ShopItem item) {
            ...
            if (item == ShopItem.GARDENING_TROWEL || item == ShopItem.SEED_DIBBER) {
                ...
                npc(TextUtils.formatDisplayName(item.getItem().getName()) + ", eh? I might have " + type + " put aside for myself.", "Tell you what, I'll sell you " + type + " " + item.getItem().getName().toLowerCase() + " for " + item.getPrice().getCount() + "GP if", "you like.");
            }
            stage = 35;
        }
    ...
    public enum ShopItem {
        ...
        PLANT_CURE(new Item(6036), new Item(Item.COINS, 25)),
        COMPOST(new Item(6032), new Item(Item.COINS, 35)),
        RAKE(new Item(5341), new Item(Item.COINS, 15)),
        WATERING_CAN(new Item(5331), new Item(Item.COINS, 25)),
        GARDENING_TROWEL(new Item(5325), new Item(Item.COINS, 15)),
        SEED_DIBBER(new Item(5343), new Item(Item.COINS, 15));
    ...
    public enum Gardener {
        ALAIN(2339, new Location(2935, 3437, 0)),
        TREZNOR(2341, new Location(3228, 3458, 0)),
        AMAETHWR(2860, new Location(2345, 3162, 0)),
        BOLONGO(2343, new Location(2475, 3445, 0)),
        DANTAERA(2324, new Location(2808, 3467, 0), new Location(2808, 3459, 0)),
        DREVEN(2335, new Location(3181, 3357, 0)),
        ELLENA(2331, new Location(2860, 3433, 0)),
        ELSTAN(2323, new Location(3051, 3308, 0), new Location(3058, 3308, 0)),
        GARTH(2330, new Location(2764, 3212, 0)),
        GILETH(2344, new Location(2489, 3179, 0)),
        FAYETH(2342, new Location(3192, 3230, 0)),
        FRANCIS(2327, new Location(3810, 3336, 0)),
        FRIZZY_SKERNIP(4560, new Location(3059, 3257, 0)),
        HESKEL(2340, new Location(3003, 3372, 0)),
        KRAGEN(2325, new Location(2665, 3378, 0), new Location(2667, 3371, 0)),
        LYRA(2326, new Location(3605, 3525, 0), new Location(3598, 3526, 0)),
        MY_ARM(4947, new Location(2826, 3694, 0)),
        PRAISTAN_EBOLA(4562, new Location(2801, 3202, 0)),
        PRISSY_SCILLA(1037, new Location(2435, 3414, 0)),
        ROHNEN(2334, new Location(2664, 3525, 0)),
        SELENA(2332, new Location(2575, 3106, 0)),
        TARIA(2336, new Location(2940, 3221, 0)),
        TORRELL(2338, new Location(2617, 3225, 0)),
        VASQUEN(2333, new Location(3227, 3315, 0));
