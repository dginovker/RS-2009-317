...
import org.gielinor.game.content.skill.free.crafting.pottery.FirePotteryPulse;
import org.gielinor.game.content.skill.free.crafting.pottery.PotteryItem;
import org.gielinor.game.content.skill.free.crafting.pottery.PotteryPulse;
 ...
 *
 * @author 'Vexia
 *         TODO 317 - Fire Pottery Oven ids need to be fixed (use on object)
 */
public final class PotteryPlugin extends UseWithHandler {
     ...
     */
    private static final int[] OVENS = new int[]{ 4308, 11601, 14888, 21302 };
    ...
    public Plugin<Object> newInstance(Object arg) throws Throwable {
        ...
        addHandler(14887, OBJECT_TYPE, this);
    ...
    public boolean handle(final NodeUsageEvent event) {
        ...
        new SkillDialogueHandler(player, SkillDialogue.FIVE_OPTION, (Object[]) getPottery(false)) {
            ...
            public int getAll(int index) {
                return player.getInventory().getCount(SOFT_CLAY);
            }
    ...
    public class FireOvenPlugin extends OptionHandler {
        ...
        public SkillDialogueHandler getSkillHandler(final Player player) {
            return new SkillDialogueHandler(player, SkillDialogue.FIVE_OPTION, (Object[]) getPottery(true)) {
                ...
                @Override
                public int getAll(int index) {
                    return player.getInventory().getCount(PotteryItem.values()[index].getUnfinished());
                }
            };
        }
