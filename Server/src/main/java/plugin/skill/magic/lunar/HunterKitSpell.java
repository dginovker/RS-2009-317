...
public final class HunterKitSpell extends MagicSpell {
    ...
    public Plugin<SpellType> newInstance(SpellType arg) throws Throwable {
        SpellBook.LUNAR.register(30099, this);
        ItemDefinition.forId(KIT.getId()).getConfigurations().put("option:open", new OptionHandler() {
            ...
            public boolean handle(Player player, Node node, String option) {
                ...
                if (player.getInventory().remove((Item) node)) {
                    player.getInventory().add(new Item(10150), new Item(10010), new Item(10006), new Item(10031), new Item(10029), new Item(596), new Item(10008));
                }
                return true;
            }
    ...
    public boolean cast(Entity entity, Node target) {
        ...
        if (p.getInventory().freeSlots() == 0) {
            p.getActionSender().sendMessage("Not enough inventory space!");
            return false;
        }
