...
public final class BakePieSpell extends MagicSpell {
    ...
    public Plugin<SpellType> newInstance(SpellType arg) throws Throwable {
        SpellBook.LUNAR.register(30017, this);
        return this;
    }
    ...
    public boolean cast(Entity entity, Node target) {
        ...
        if (food == null) {
            player.getActionSender().sendMessage("You need a pie in order to cast this spell.");
            return false;
        }
    ...
    public final class LunarPiePulse extends SkillPulse<Item> {
        ...
        public boolean checkRequirements() {
            if (player.getSkills().getLevel(Skills.COOKING) < pie.getCookingProperties().getLevel()) {
                player.getDialogueInterpreter().sendPlaneMessage("You need to have a Cooking level of t " + pie.getCookingProperties().getLevel() + " to cook this pie.");
                return false;
            }
