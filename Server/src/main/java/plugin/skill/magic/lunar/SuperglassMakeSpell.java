...
public class SuperglassMakeSpell extends MagicSpell {
    ...
    public Plugin<SpellType> newInstance(SpellType arg) throws Throwable {
        SpellBook.LUNAR.register(30154, this);
        return this;
    }
    ...
    public boolean cast(Entity entity, Node target) {
        ...
        int sand = player.getInventory().getCount(BUCKET_OF_SAND);
        if (setIndex == -1) {
            player.getActionSender().sendMessage("You don't have the required ingredients.");
            return false;
        }
