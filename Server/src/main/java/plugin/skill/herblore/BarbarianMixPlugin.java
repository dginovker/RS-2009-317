...
import org.gielinor.game.content.skill.member.herblore.BarbarianPotion;
...
public final class BarbarianMixPlugin extends UseWithHandler {
    ...
    public boolean handle(NodeUsageEvent event) {
        ...
        if (player.getSkills().getLevel(Skills.HERBLORE) < potion.getLevel()) {
            player.getActionSender().sendMessage("You need a herblore level of " + potion.getLevel() + " to make this mix.");
            return true;
        }
