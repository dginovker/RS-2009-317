...
/**
 * Represents the plugin used to handle the fishing expolosive on a omnious fishing spot.
 *
 * @author 'Vexia
 */
public final class FishingExplosivePlugin extends OptionHandler {
    ...
    public boolean handle(Player player, Node node, String option) {
        player.getActionSender().sendMessage("Something seems to have scared all the fishes away...");
        return true;
    }
    ...
    public static final class FishingExplosiveHandler extends UseWithHandler {
        ...
        public boolean handle(final NodeUsageEvent event) {
            ...
            if (!player.getSlayer().hasTask() || player.getSlayer().getTask() != Tasks.MOGRES.getTask()) {
            ...
            player.getActionSender().sendMessage("You hurl the shuddering vial into the water...");
            ...
            World.submit(new Pulse(delay, player) {
                ...
                public boolean pulse() {
                    ...
                    mogre.sendChat(MESSAGES[RandomUtil.random(MESSAGES.length)]);
                    ...
                    player.getActionSender().sendPositionedGraphics(SPLASH_GRAPHIC, event.getUsedWith().getLocation());
                    player.getActionSender().sendMessage("...and a Mogre appears!");
                    return true;
                }
            });
            return true;
        ...
        /**
         * Method used to send the fishing explosive projectile.
         *
