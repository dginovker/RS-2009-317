...
public final class PCPortalNPC extends AbstractNPC {
    ...
    private static final int[][] SPLATTERS = {
        { 3728, 3729, 3730 },//{3727, 3728, 3729}, //Novice
    ...
    private static final int[][] SHIFTERS = {
        { 3734, 3735, 3736, 3737, 3738, 3739 },//{3732, 3733, 3734, 3735, 3736, 3737}, //Novice
    ...
    private static final int[][] RAVAGERS = {
        { 3743, 3744, 3745 },// {3742, 3743, 3744}, //Novice
    ...
    private static final int[][] SPINNERS = {
        { 3748, 3749, 3750 },//  {3747, 3748, 3749}, //Novice
    ...
    private static final int[][] TORCHERS = {
        { 3754, 3755, 3756, 3757, 3758, 3759 },// {3752, 3753, 3754, 3755, 3756, 3757}, //Novice
    ...
    private static final int[][] DEFILERS = {
        { 3764, 3765, 3766, 3767, 3768, 3769 },// {3762, 3763, 3764, 3765, 3766, 3767}, //Novice
    ...
    private static final int[][] BRAWLERS = {
        { 3773, 3774, 3775 },//   {3772, 3773, 3774}, //Novice
    ...
    public void tick() {
        ...
        if (session != null) {
            ...
            if (updateLifepoints && session.getTicks() % 10 == 0) {
                ...
                session.sendString(color + getSkills().getLifepoints(), 24538 + getPortalIndex());
    ...
    public void spawnNPCs() {
        ...
        for (int i = 0; i < 3; i++) {//2 + (getViewport().getCurrentPlane().getPlayers().size() / 10); i++) {
    ...
    public void finalizeDeath(Entity killer) {
        ...
        if (session != null) {
            ...
            session.sendString("<col=FF0000>0", 24538 + getPortalIndex());
            updateLifepoints = false;
