...
public final class BarrowsEquipment extends DegradableEquipment {
    ...
    public static void init() {
        PluginManager.definePlugin(new BarrowsEquipment(Equipment.SLOT_HAT,
        ...
        PluginManager.definePlugin(new BarrowsEquipment(Equipment.SLOT_WEAPON,
        ...
        PluginManager.definePlugin(new BarrowsEquipment(Equipment.SLOT_CHEST,
        ...
        PluginManager.definePlugin(new BarrowsEquipment(Equipment.SLOT_LEGS,
    ...
    public void degrade(Player player, Entity entity, Item item) {
        ...
        if (index % 5 == 0 || item.getCharge() < 1) {
            ...
            player.getActionSender().sendMessage("Your " + name + " has degraded slightly.");
            if (index % 5 == 4) {
