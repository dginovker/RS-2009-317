...
public final class GodWarsNPC extends AbstractNPC {
    ...
    private static final AggressiveBehavior AGGRO_BEHAVIOR = new AggressiveBehavior() {
        ...
        public boolean canSelectTarget(Entity entity, Entity target) {
            ...
            if (target instanceof GodWarsNPC) {
                ...
                if (((GodWarsNPC) entity).faction == null) {
                    return false;
                }
    ...
    public int[] getIds() {
        return new int[]{
            ...
            6219, 6220, 6221, 6229, 6230, 6231, 6232, 6233, 6234,
            6235, 6236, 6237, 6238, 6239, 6240, 6241, 6242, 6243,
            6244, 6245, 6246, 6254, 6255, 6256, 6257, 6258, 6259,
    ...
    static enum GodWarsFaction {
        ARMADYL(6222, 6246,
            87, 6232, 6233, 6234, 6235, 6236, 6237, 6238, 6239, 6240, 6241, 6242, 6243, 6244,
            6245, 6246, 11694, 11718, 11720, 11722, 12670, 12671),
        BANDOS(6260, 6283, 11061, 11696, 11724, 11726, 11728),
        SARADOMIN(6247, 6259, 542, 544, 6247, 6259,
         ...
         * @return {@code True} if no NPCs of this faction should attack the player.
         */
        public boolean isProtected(Player player) {
            ...
            if (Perk.GOD_WARS_EQUAL.enabled(player)) {
                return true;
            }
            return false;
        }
