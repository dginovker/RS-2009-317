            ...
            case "climb-up":
                switch (id) {
                    case 2511:
                        ...
                        player.getInterfaceState().open(new Component(564));
                        break;
                }
                break;
            case "climb-down":
        ...
        public boolean handle(int interfaceId, OptionSelect optionSelect) {
            switch (stage) {
                ...
                case 11:
                    ...
                    Shops.AUTHENTIC_THROWING_WEAPONS.open(player);
                    break;
                case 20:
                    npc("No bother to me.");
                    stage = 21;
        ...
        public boolean handle(int interfaceId, OptionSelect optionSelect) {
            switch (stage) {
                ...
                case 21:
                    ...
                    Shops.AARONS_ARCHERY_APPENDAGES.open(player);
                    break;
                case 30:
                ...
                case 2:
                    switch (optionSelect) {
                        case TWO_OPTION_ONE:
                            ...
                            Shops.DARGAUDS_BOWS_AND_ARROWS.open(player);
                            break;
                        case TWO_OPTION_TWO:
                            end();
                            break;
